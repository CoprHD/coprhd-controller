...
public final class CustomServicesConstants {
    ...
    public static final String ERROR_MSG_INVENTORY_FILE_NOT_MAPPED = "Inventory files does not exist/ recently deleted for the package mapped in the primitive";
