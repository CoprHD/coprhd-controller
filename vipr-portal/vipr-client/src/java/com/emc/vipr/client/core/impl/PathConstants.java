...
public class PathConstants {
    ...
    public static final String APP_SUPPORT_CLONE_SET_URL = APP_SUPPORT_CLONE_URL + "/full-copy-sets";
    public static final String APP_SUPPORT_CLONE_SET_URL_PARTICULAR = APP_SUPPORT_CLONE_SET_URL + "{id}";
