 ...
 *
 */
public class SyncstopApplicationMigration extends WaitForTasks<TaskResourceRep> {
     ...
     */
    public SyncstopApplicationMigration(URI mobilityGroupId) {
        super();
    ...
    protected Tasks<TaskResourceRep> doExecute() throws Exception {
        TaskList taskList = getClient().application().syncstopMigration(mobilityGroupId);
