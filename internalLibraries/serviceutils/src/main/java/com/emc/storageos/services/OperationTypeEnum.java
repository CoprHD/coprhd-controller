...
public enum OperationTypeEnum {
    ...
    REGISTER_STORAGE_PORT_GROUP("REGIESTER PORT GROUP", "", "Storage port group is registered"), DEREGISTER_STORAGE_PORT_GROUP(
            "DEREGIESTER PORT GROUP", "", "Storage port group is unregistered"), CREATE_STORAGE_PORT_GROUP("CREATE STORAGE PORT GROUP", "",
                    "Storage port group is created"), DELETE_STORAGE_PORT_GROUP("DELETE STORAGE PORT GROUP", "",
                            "Storage port group is deleted"),
