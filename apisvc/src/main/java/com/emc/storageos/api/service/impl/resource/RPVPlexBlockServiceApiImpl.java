...
public class RPVPlexBlockServiceApiImpl extends AbstractBlockServiceApiImpl<RPVPlexScheduler> {
    ...
    private List<URI> prepareVPlexRecommendedVolumes(VolumeCreate param, String task, TaskList taskList,
        ...
        while (recommendationsIter.hasNext()) {                	
            ...
            for (int volumeCount = 0; volumeCount < volumeCountInRec; volumeCount++) {  
                ...
                // MetroPoint and Distributed RP+VPLEX(HA as RP source) Source volumes need to have their backing volumes set with the correct internal 
     ...
     */
    private Volume createJournalVolume(RPProtectionRecommendation recommendation, String task, TaskList taskList, 
    	...
    	RPProtectionRecommendation journalRec = createTempRecommendation(recommendation,vplexURI, varray.getId(),
    ...
    private Volume prepareVPlexVirtualVolume(Volume volume, Project project, VirtualArray varray,
									            ...
									            RPProtectionRecommendation primaryRecommendation, 
									            RPProtectionRecommendation secondaryRecommendation) {
