	...
	public void discoverUnManagedFileSystems(AccessProfile accessProfile, DbClient dbClient,
		...
		if(filesystems != null && !filesystems.isEmpty()) {
			...
			for(VNXeFileSystem fs: filesystems){
	            ...
	            //Create UnManaged FS
	        	 String fsUnManagedFsNativeGuid = NativeGUIDGenerator.generateNativeGuidForPreExistingFileSystem(storageSystem.getSystemType(),
			...
			if(exp.getParentFilesystem() != null) {
				...
				try {		           
					...
					if(unManagedExportRule == null) {
						...
						unManagedExpRule = createExportRules(unManagedFs.getId(), apiClient, exp, unManagedExportRule, mountPath, mountPoint, 
