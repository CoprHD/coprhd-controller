...
public class LoggingFilterTest {
    public static final String SOMETHING_WITH_PASSWORDS = "<password>MYPASSWORD</password>";
    public static final String SOMETHING_WITH_PASSWORD_MAP = "<map><key>password</key><value>MYPASSWORD</value></map>";
