...
public enum ResourceOperationTypeEnum {
    ...
    FAILBACK_REMOTE_REPLICATION_GROUP_LINK("FAILBACK REMOTE REPLICATION GROUP LINK", "failback remote replication group link"),
    ESTABLISH_REMOTE_REPLICATION_GROUP_LINK("ESTABLISH REMOTE REPLICATION GROUP LINK", "establish remote replication group link"),
    SPLIT_REMOTE_REPLICATION_GROUP_LINK("SPLIT REMOTE REPLICATION GROUP LINK", "split remote replication group link"),
    SUSPEND_REMOTE_REPLICATION_GROUP_LINK("SUSPEND REMOTE REPLICATION GROUP LINK", "suspend remote replication group link"),
    RESUME_REMOTE_REPLICATION_GROUP_LINK("RESUME REMOTE REPLICATION GROUP LINK", "resume remote replication group link"),
    RESTORE_REMOTE_REPLICATION_GROUP_LINK("RESTORE REMOTE REPLICATION GROUP LINK", "restore remote replication group link"),
    SWAP_REMOTE_REPLICATION_GROUP_LINK("SWAP REMOTE REPLICATION GROUP LINK", "swap remote replication group link"),
    STOP_REMOTE_REPLICATION_GROUP_LINK("STOP REMOTE REPLICATION GROUP LINK", "stop remote replication group link"),
    CHANGE_REMOTE_REPLICATION_MODE("CHANGE REMOTE REPLICATION MODE", "change remote replication mode"),
    CHANGE_REMOTE_REPLICATION_GROUP("CHANGE REMOTE REPLICATION GROUP", "change remote replication group"),
    MOVE_REMOTE_REPLICATION_PAIR("MOVE_REMOTE_REPLICATION_PAIR", "move remote replication pair"),
    FAILOVER_REMOTE_REPLICATION_SET_LINK("FAILOVER REMOTE REPLICATION SET LINK", "failover remote replication set link"),
    FAILBACK_REMOTE_REPLICATION_SET_LINK("FAILBACK REMOTE REPLICATION SET LINK", "failback remote replication set link"),
    ESTABLISH_REMOTE_REPLICATION_SET_LINK("ESTABLISH REMOTE REPLICATION SET LINK", "establish remote replication set link"),
    SPLIT_REMOTE_REPLICATION_SET_LINK("SPLIT REMOTE REPLICATION SET LINK", "split remote replication set link"),
    SUSPEND_REMOTE_REPLICATION_SET_LINK("SUSPEND REMOTE REPLICATION SET LINK", "suspend remote replication set link"),
    RESUME_REMOTE_REPLICATION_SET_LINK("RESUME REMOTE REPLICATION SET LINK", "resume remote replication set link"),
    RESTORE_REMOTE_REPLICATION_SET_LINK("RESTORE REMOTE REPLICATION SET LINK", "restore remote replication set link"),
    SWAP_REMOTE_REPLICATION_SET_LINK("SWAP REMOTE REPLICATION SET LINK", "swap remote replication set link"),
    STOP_REMOTE_REPLICATION_SET_LINK("STOP REMOTE REPLICATION SET LINK", "stop remote replication set link"),
    FAILOVER_REMOTE_REPLICATION_PAIR_LINK("FAILOVER REMOTE REPLICATION PAIR LINK", "failover remote replication pair link"),
    FAILBACK_REMOTE_REPLICATION_PAIR_LINK("FAILBACK REMOTE REPLICATION PAIR LINK", "failback remote replication pair link"),
    ESTABLISH_REMOTE_REPLICATION_PAIR_LINK("ESTABLISH REMOTE REPLICATION PAIR LINK", "establish remote replication pair link"),
    SPLIT_REMOTE_REPLICATION_PAIR_LINK("SPLIT REMOTE REPLICATION PAIR LINK", "split remote replication pair link"),
    ...
    RESTORE_REMOTE_REPLICATION_PAIR_LINK("RESTORE REMOTE REPLICATION PAIR LINK", "restore remote replication pair link"),
    SWAP_REMOTE_REPLICATION_PAIR_LINK("SWAP REMOTE REPLICATION PAIR LINK", "swap remote replication pair link"),
    STOP_REMOTE_REPLICATION_PAIR_LINK("STOP REMOTE REPLICATION PAIR LINK", "stop remote replication pair link"),
    SWAP_REMOTE_REPLICATION_CG_LINK("SWAP REMOTE REPLICATION CG LINK", "swap remote replication cg link"),
    STOP_REMOTE_REPLICATION_CG_LINK("STOP REMOTE REPLICATION CG LINK", "stop remote replication cg link"),
    FAILOVER_REMOTE_REPLICATION_CG_LINK("FAILOVER REMOTE REPLICATION CG LINK", "failover remote replication cg link"),
    ESTABLISH_REMOTE_REPLICATION_CG_LINK("ESTABLISH REMOTE REPLICATION CG LINK", "establish remote replication cg link"),
    FAILBACK_REMOTE_REPLICATION_CG_LINK("FAILBACK REMOTE REPLICATION CG LINK", "failback remote replication cg link"),
    SPLIT_REMOTE_REPLICATION_CG_LINK("SPLIT REMOTE REPLICATION CG LINK", "split remote replication cg link"),
    SUSPEND_REMOTE_REPLICATION_CG_LINK("SUSPEND REMOTE REPLICATION CG LINK", "suspend remote replication cg link"),
    RESUME_REMOTE_REPLICATION_CG_LINK("RESUME REMOTE REPLICATION CG LINK", "resume remote replication cg link"),
    RESTORE_REMOTE_REPLICATION_CG_LINK("RESTORE REMOTE REPLICATION CG LINK", "restore remote replication cg link"),
