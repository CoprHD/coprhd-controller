...
public class IsilonMirrorOperations implements FileMirrorOperations {
    ...
    public BiosCommandResult doFailBack(StorageSystem primarySystem, StorageSystem secondarySystem, String policyName,
        ...
        try {
            /*
             * Step 1. Creates a mirror replication policy for the secondary cluster i.e Resync-prep on primary cluster
             * , this will disable
            ...
            /*
             * Step 2. Start the mirror replication policy manually, this will replicate new data (written during
            ...
            /*
             * Step 4. Resync-Prep on secondary cluster , same as step 1 but will be executed on secondary cluster
             * instead of primary
             * cluster.
             */
