 ...
 * NetworkDeviceControllerExceptions.properties and use the annotation {@link DeclareServiceCode}
...
public interface NetworkDeviceControllerExceptions {
    ...
    @DeclareServiceCode(ServiceCode.CONTROLLER_NETWORK_ERROR)
    public NetworkDeviceControllerException failedToGetEndpointZones(final Collection<String> endpoints, final String network, final String cause);    
