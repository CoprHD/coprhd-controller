...
/etc/genconfig.d/boot/10connectemc
/etc/genconfig.d/boot/00dns
/etc/genconfig.d/boot/00firewall
/etc/genconfig.d/boot/00network
/etc/genconfig.d/boot/00ntp
/etc/genconfig.d/boot/00security
/etc/genconfig.d/boot/00system
