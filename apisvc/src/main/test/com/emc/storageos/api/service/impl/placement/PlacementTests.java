...
public class PlacementTests extends DbsvcTestBase {
    ...
    public void testPlacementVPlexHARemote() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            _log.info("Recommendation " + i + ": " + recommendations.size() + ", Src Pool Chosen: " + srcRec.getSourcePool().toString()
                    + ", HA Pool Chosen: " + HARec.getSourcePool().toString());
        }
    }
    ...
    public void testPlacementRp() {
        ...
        ProtectionSystem rpSystem = PlacementTestUtils.createProtectionSystem(_dbClient, "rp", "rp1", "site1", "site2", "IP",
        ...
        for (int i = 0; i < 10; i++) {
            ...
            assertTrue(("pool2".equals(rec.getSourcePool().toString())) || ("pool1".equals(rec.getSourcePool().toString())));
            assertTrue(("pool2".equals(rec.getSourceJournalStoragePool().toString()))
                    || ("pool1".equals(rec.getSourceJournalStoragePool().toString())));
            assertTrue(("pool5".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetStoragePool().toString()))
                    || ("pool4".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetStoragePool().toString())));
            assertTrue(("pool5".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetJournalStoragePool()
                    .toString()))
                    || ("pool4".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetJournalStoragePool()
                            .toString())));
            _log.info("Recommendation " + i + ": " + recommendations.size() + ", Source Pool Chosen: " + rec.getSourcePool().toString()
                    + ", Target Pool Chosen: "
                    + rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetStoragePool().toString());
        }
    }
    ...
    public void testPlacementRpXIO() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            assertTrue("IDENTIFIED_SOLUTION_FOR_ALL_TARGETS".equals(rec.getPlacementStepsCompleted().name()));
            assertTrue(rec.getVirtualArrayProtectionMap().containsKey(URI.create("varray2")));
            assertTrue(("xtremio4".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetDevice().toString()))
                    || ("xtremio5".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetDevice().toString())));
            assertTrue(("xtremio4"
                    .equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetJournalDevice().toString()))
                    || ("xtremio5"
                            .equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetJournalDevice().toString())));
            assertTrue("site2".equals(rec.getVirtualArrayProtectionMap().get(URI.create("varray2")).getTargetInternalSiteName()));
            assertTrue(("pool2".equals(rec.getSourcePool().toString())) || ("pool1".equals(rec.getSourcePool().toString())));
    ...
    public void testPlacementRpVplex() {
        ...
        for (int i = 0; i < 10; i++) {
            List recommendations = PlacementTestUtils
                    .invokePlacement(_dbClient, _coordinator, varray2, project, rpVplexVpool, capabilities);
            ...
            VPlexRecommendation recVplex = (VPlexProtectionRecommendation) ((VPlexProtectionRecommendation) recommendations.get(0))
                    .getSourceVPlexHaRecommendations().get(0);
            ...
            assertTrue(("pool5".equals(rec.getSourceJournalStoragePool().toString()))
                    || ("pool4".equals(rec.getSourceJournalStoragePool().toString())));

            assertTrue("vplex2"
                    .equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetVplexDevice().toString()));
            assertTrue("vmax3".equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetDevice().toString()));
            assertTrue("vmax3".equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetJournalDevice()
                    .toString()));
            ...
            assertTrue("vpoolRP".equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetVpool().getId()
                    .toString()));
            assertTrue(("pool8"
                    .equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetStoragePool().toString()))
                    || ("pool7"
                            .equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetStoragePool().toString())));
            assertTrue(("pool8".equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetJournalStoragePool()
                    .toString()))
                    || ("pool7".equals(recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetJournalStoragePool()
                            .toString())));
            ...
            _log.info("Recommendation " + i + ": " + recommendations.size() + ", Source Pool Chosen: " + rec.getSourcePool().toString()
                    + ", Target Pool Chosen: "
                    + recVplexProt.getVarrayVPlexProtection().get(URI.create("varray3")).getTargetStoragePool().toString());
        }
    }
