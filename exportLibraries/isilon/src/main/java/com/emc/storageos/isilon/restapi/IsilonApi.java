...
public class IsilonApi {
    ...
    public String createExport(IsilonExport exp, String zoneName) throws IsilonException {
    	...
    	StringBuffer exportURL = new StringBuffer(_baseUrl.resolve(URI_NFS_EXPORTS).toString());
    	exportURL.append("?zone=").append(zoneName);

        return create(URI.create(exportURL.toString()), "Export", exp);
    }
    ...
    public String createShare(IsilonSMBShare smbFileShare, String zoneName) throws IsilonException {
    	...
    	StringBuffer exportURL = new StringBuffer(_baseUrl.resolve(URI_SMB_SHARES).toString());
    	exportURL.append("?zone=").append(zoneName);
        return create(URI.create(exportURL.toString()), "share", smbFileShare);
    }
