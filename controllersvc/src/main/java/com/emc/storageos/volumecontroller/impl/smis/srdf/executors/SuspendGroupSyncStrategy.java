...
/**
 * Created by bibbyi1 on 4/10/2015.
 */
public class SuspendGroupSyncStrategy implements ExecutorStrategy {
    private SmisCommandHelper helper;

    public SuspendGroupSyncStrategy(SmisCommandHelper helper) {
        this.helper = helper;
    }

    @Override
    public void execute(Collection<CIMObjectPath> objectPaths, StorageSystem provider) throws WBEMException {
        CIMArgument[] args = helper.getASyncPairSuspendInputArguments(objectPaths.iterator().next());
