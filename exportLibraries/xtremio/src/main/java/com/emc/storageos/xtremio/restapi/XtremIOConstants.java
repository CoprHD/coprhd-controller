...
public class XtremIOConstants {
    ...
    public static final String XTREMIO_CONSISTENCY_GROUPS_STR = XTREMIO_BASE_STR.concat("/consistency-groups");
    public static final String XTREMIO_CONSISTENCY_GROUP_VOLUMES_STR = XTREMIO_BASE_STR.concat("/consistency-group-volumes");
    public static final String XTREMIO_TAGS_STR = XTREMIO_BASE_STR.concat("/tags");
	...
	public static String getXIOVolumeFolderURI(String volumeFolderName, String clusterName) throws Exception {
		if(clusterName != null && !clusterName.isEmpty()) {
			return XTREMIO_VOLUME_FOLDERS_STR.concat(getInputNameForClusterString(volumeFolderName, clusterName));
		} else {
			return XTREMIO_VOLUME_FOLDERS_STR.concat(getInputNameString(volumeFolderName));
		}
	}
	
	public static String getXIOIGFolderURI(String igFolderName, String clusterName) throws Exception {
		if(clusterName != null && !clusterName.isEmpty()) {
			return XTREMIO_INITIATOR_GROUPS_FOLDER_STR.concat(getInputNameForClusterString(igFolderName, clusterName));
		} else {
