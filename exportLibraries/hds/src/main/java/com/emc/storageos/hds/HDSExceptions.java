 ...
 * HDSExceptions.properties and use the annotation {@link DeclareServiceCode}
...
public interface HDSExceptions {
    ...
    public HDSException notAbleToAddInitiatorToHostStorageDomain(final String initiatorType, final String hostStorageDomainId, final String systemId);
