...
public class IBMSVCHelper {
    ...
    public static Map<String, List<String>> getHostInitiatorMap(List<Initiator> initiators){
        List<String> listInitiator;

        Map<String, List<String>> hostInitiatorMap = new HashMap<>();
        ...
        for (Initiator initiator : initiators) {
            ...
            String initiatorPort = initiator.getPort().replaceAll(":", "");

            if(hostInitiatorMap.containsKey(hostName)){
                listInitiator = hostInitiatorMap.get(hostName);
            }else{
                listInitiator = new ArrayList<>();
            }

            listInitiator.add(initiatorPort);
            hostInitiatorMap.put(hostName, listInitiator);
