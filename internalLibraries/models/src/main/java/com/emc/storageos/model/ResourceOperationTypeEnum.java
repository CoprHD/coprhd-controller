...
public enum ResourceOperationTypeEnum {
    ...
    DISCOVER_MANAGEMENT_STATION("DISCOVER MANAGEMENT STATION", "discover a management station"),
    DELETE_MANAGEMENT_STATION("DELETE MANAGEMENT STATION", "delete a management station"),
