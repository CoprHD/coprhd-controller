...
public class SmisMetaVolumeOperations implements MetaVolumeOperations {
     ...
     */
    public void createMetaVolume(StorageSystem storageSystem, StoragePool storagePool, Volume metaHead, List<String> metaMembers, String metaType,
                                 VirtualPoolCapabilityValuesWrapper capabilities, MetaVolumeTaskCompleter metaVolumeTaskCompleter) throws Exception {
        ...
        try {
            ...
            // Check if meta head is bound to pool. The binding state is not changed by create meta volume call below, so we can know in advance if we need
...
//                    taskCompleter);
     ...
     */
    public void expandVolumeAsMetaVolume(StorageSystem storageSystem, StoragePool storagePool, Volume metaHead, List<String> metaMembers, String metaType,
...
//               _helper.invokeMethod(storageSystem, elementCompositionServicePath, SmisConstants.CREATE_OR_MODIFY_COMPOSITE_ELEMENT, inArgs, outArgs);
...
//            }
    ...
    public void deleteBCVHelperVolume(StorageSystem storageSystem, Volume volume) throws Exception {
        ...
        try {
            ...
            String query = String.format("SELECT CIM_StorageVolume.%s, CIM_StorageVolume.%s  FROM CIM_StorageVolume where CIM_StorageVolume.%s ='SMI_BCV_META_%s'",
                    SmisConstants.CP_ELEMENT_NAME, SmisConstants.CP_DEVICE_ID, SmisConstants.CP_ELEMENT_NAME, deviceNameWithoutLeadingZeros);
            ...
            if (bcvVolumeInstanceList == null || bcvVolumeInstanceList.isEmpty()) {
                ...
                query = String.format("SELECT CIM_StorageVolume.%s, CIM_StorageVolume.%s FROM CIM_StorageVolume where CIM_StorageVolume.%s ='SMI_BCV_META_%s'",
    ...
    @Override
    public String defineExpansionType(StorageSystem storageSystem, Volume volume, String recommendedMetaVolumeType, MetaVolumeTaskCompleter metaVolumeTaskCompleter)
            throws Exception {
