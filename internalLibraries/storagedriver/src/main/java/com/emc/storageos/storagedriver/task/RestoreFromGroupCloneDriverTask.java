 ...
 * to restore a group clone will be completed asynchronously. The clones managed and
 * returned by this task should contain the updated clone data when the task
 * completes successfully.
 */
public class RestoreFromGroupCloneDriverTask extends DriverTask {
     ...
     */
    public RestoreFromGroupCloneDriverTask(String taskId, List<VolumeClone> volumeClones) {
        super(taskId);
