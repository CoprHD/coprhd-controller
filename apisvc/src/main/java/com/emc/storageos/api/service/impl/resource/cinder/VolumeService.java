...
public class VolumeService extends TaskResourceService {
	...
	public Response createVolume(@PathParam("tenant_id") String openstack_tenant_id,
		...
		if(hasConsistencyGroup && blockConsistencyGroupId != null){
		    ...
		    volumeCreate.setConsistencyGroup(blockConsistencyGroupId);
		        ...
		        CinderApiUtils.createErrorResponse(400, "Bad Request : can't create volume for the consistency group : " + blockConsistencyGroupId);
		    }
		}
		if (sourceVolId != null)
		{
    ...
    private TaskList createTaskList(long size, Project project, VirtualArray varray, VirtualPool vpool, String label, String task,
	    ...
	    public void checkForConsistencyGroup(VirtualPool vpool,
	            ...
	            BlockServiceApi blockServiceImpl, VirtualArray varray, VirtualPoolCapabilityValuesWrapper capabilities, BlockFullCopyManager blkFullCpManager) {
