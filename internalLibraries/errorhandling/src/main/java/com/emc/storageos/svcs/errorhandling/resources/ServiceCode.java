...
public enum ServiceCode {
    ...
    API_INVALID_MAX_CONTINUOUS_COPIES(1043),
    API_INVALID_HIGH_AVAILABILITY_FOR_MIRROR_VPOOL(1044),
    API_INVALID_VARARY_CONTINUOUS_COPIES_VPOOL(1045),
    API_INVALID_ACTION_FOR_VPLEX_MIRRORS(1046),
    API_VPOOL_IN_USE_AS_CONTINUOUS_COPIES_VPOOL(1047),
    API_NOT_INITIALIZED(1048),
    API_INVALID_CONTINUOUS_COPIES_VPOOL(1049),
    API_PARAMETER_REQUIRED(1050),
    API_CANNOT_DEREGISTER(1051),
    API_RESOURCE_CANNOT_BE_DELETE_DUE_TO_UNREACHABLE_VDC(1052),
    API_INVALID_OBJECT(1053),
    API_PARAMETER_INVALID_QDNAME(1054),
    API_AUTH_KEYSTONE_PROVIDER_CREATE_NOT_ALLOWED(1055),
    API_DUPLICATE_EXPORT_GROUP_NAME_SAME_PROJECT_AND_VARRAY(1056),
    API_DELETION_IN_PROGRESS(1057),
    API_TASK_EXECUTION_IN_PROGRESS(1058),
    API_PRECONDITION_FAILED(1059),
    API_INTERNAL_LOCK_ERROR(1060),
    ...
    ECS_CONNECTION_ERROR(65001),
    ECS_RETURN_PARAM_ERROR(65002),
    ECS_LOGINVALIDATE_ERROR(65003),
    ECS_STORAGEPOOL_ERROR(650004),
    ECS_STATS_ERROR(65005),
    ECS_NON_SYSTEM_ADMIN_ERROR(65006),
