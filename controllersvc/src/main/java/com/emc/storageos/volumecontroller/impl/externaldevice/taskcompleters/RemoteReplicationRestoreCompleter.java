...
public class RemoteReplicationRestoreCompleter extends TaskCompleter {

    private static final Logger _logger = LoggerFactory.getLogger(RemoteReplicationRestoreCompleter.class);
    ...
    public RemoteReplicationRestoreCompleter(RemoteReplicationElement remoteReplicationElement, String opId) {
