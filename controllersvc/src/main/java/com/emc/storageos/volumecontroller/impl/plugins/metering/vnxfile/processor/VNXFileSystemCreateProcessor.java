...
/**
 * VNXFileSystemCreateProcessor is responsible for creating file systems
 * on the VNX.
 */
public class VNXFileSystemCreateProcessor extends VNXFileProcessor {

    private final Logger _logger = LoggerFactory.getLogger(VNXFileSystemCreateProcessor.class);
