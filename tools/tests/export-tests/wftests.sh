...
test_4() {
    ...
    if [ "${SS}" = "vplex" ]
    then
	storage_failure_injections="failure_004:failure_074_VPlexDeviceController.deleteStorageDevice_before_delete"
    fi 
    ...
    # Placeholder when a specific failure case is being worked...
    #failure_injections="failure_004:failure_074_VPlexDeviceController.deleteStorageDevice_before_delete"
