...
public class PlacementTestUtils {
    ...
    public static StoragePool createStoragePool(DbClient dbClient,
        ...
        pool1.setId(URIUtil.createId(StoragePool.class));
    ...
    public static ProtectionSystem createProtectionSystem(DbClient dbClient, String type, String label, String cluster1, String cluster2,
            String cluster3, String protocol,
    ...
    public static TenantOrg createTenantOrg(DbClient dbClient) {
