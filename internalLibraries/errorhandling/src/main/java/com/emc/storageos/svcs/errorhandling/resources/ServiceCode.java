...
public enum ServiceCode {
    ...
    SYS_DR_DATA_SYNC_TIMEOUT(30055),
    SYS_DR_SWITCHOVER_PRECHECK_FAILED(30056),
    SYS_DR_SWITCHOVER_FAILED(30057),
    SYS_DR_SWITCHOVER_PRIMARY_FAILED_TIMEOUT(30058),
    SYS_DR_SWITCHOVER_STANDBY_FAILED_TIMEOUT(30059),
    SYS_DR_ACQUIRE_OPERATION_LOCK_FAILED(30060),
    SYS_DR_CONCURRENT_OPERATION_NOT_ALLOWED(30061),
    SYS_DR_FAILOVER_FAILED(30062),
    SYS_DR_FAILOVER_PRECHECK_FAILED(30063),
    SYS_DR_FAILOVER_RECONFIG_FAIL(30064),

    SYS_INTERNAL_SERVICE_NAME_NOT_FOUND(30065),
    SYS_DR_CREATE_VIPR_CLIENT_FAILED(30066),
