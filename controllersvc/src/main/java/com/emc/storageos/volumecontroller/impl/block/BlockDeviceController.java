...
public class BlockDeviceController implements BlockController, BlockOrchestrationInterface {
    ...
    private static final String RB_CREATE_SNAPSHOT_SESSION_METHOD = "rollbackCreateBlockSnapshotSession";
    ...
    public void restoreSnapshotSession(URI systemURI, URI snapSessionURI, String opId) {
        TaskCompleter completer = new BlockSnapshotSessionRestoreWorkflowCompleter(snapSessionURI, opId);
        try {
