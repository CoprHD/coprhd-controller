...
public class RPCGCreateCompleter extends RPCGTaskCompleter {
    private static final Logger _log = LoggerFactory.getLogger(RPCGCreateCompleter.class);

    public RPCGCreateCompleter(List<URI> uris, String task) {
    ...
    protected void complete(DbClient dbClient, Operation.Status status, ServiceCoded coded) throws DeviceControllerException {
        try {
            ...
            _log.info(String.format("Done RPCGCreate - Id: %s, OpId: %s, status: %s",
