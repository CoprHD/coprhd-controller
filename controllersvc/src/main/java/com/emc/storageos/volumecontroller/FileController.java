...
public interface FileController extends StorageController {
     ...
     * 
     * @param storageType - storage system type for which these associations belongs to
     * @param associations - actual recommendations provided by ViPR
     * @param opId - task id
     * @throws InternalException
     */
    public void validateReplicationRecommendations(String storageType, URI policy, List<FileStorageSystemAssociation> associations,
            String opId)
            throws InternalException;
