...
/**
 * VNXFileSystemExpandProcessor is responsible for expand file system
 * on the VNX.
 */
public class VNXFileSystemExpandProcessor extends VNXFileProcessor {

    private final Logger _logger = LoggerFactory.getLogger(VNXFileSystemExpandProcessor.class);

    @Override
    public void processResult(Operation operation, Object resultObj, Map<String, Object> keyMap)
            throws BaseCollectionException {
        _logger.info("Processing VNX File System expand response: {}", resultObj);
