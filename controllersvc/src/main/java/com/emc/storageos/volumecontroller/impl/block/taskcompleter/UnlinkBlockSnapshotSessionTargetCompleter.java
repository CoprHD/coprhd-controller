...
public class UnlinkBlockSnapshotSessionTargetCompleter extends TaskLockingCompleter {
     ...
     */
    public UnlinkBlockSnapshotSessionTargetCompleter(URI snapSessionURI, URI snapshotURI, String stepId) {
