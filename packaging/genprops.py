...
def getprops(path):
    _keys = ( "key", "label", "description", "type", "minLen", "maxLen", "allowedValues", "tag", "advanced", "hidden", "userMutable", "userConfigurable", "rebootRequired", "reconfigRequired", "value", "controlNodeOnly", "notifiers", "siteSpecific", "poweroffAgreementRequired" )
...
BEAN_KEYS = ( "key", "label", "description", "type", "minLen", "maxLen", "allowedValues", "tag", "hidden", "advanced", "userMutable", "userConfigurable", "reconfigRequired", "rebootRequired", "value", "controlNodeOnly", "notifiers", "siteSpecific", "poweroffAgreementRequired")
