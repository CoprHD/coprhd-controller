...
public class VirtualArrayUtils {
    ...
    public static Map<String, Set<String>> getAvailableAttributes(List<URI> varrayIds) {
        ...
        for (URI varrayId : availableAttributes.keySet()) {
            List<VirtualPoolAvailableAttributesResourceRep> attributes = availableAttributes.get(varrayId);//NOSONAR ("Suppressing Sonar violation of Inefficient use of keySet iterator instead of entrySet”)
