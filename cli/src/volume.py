...
class Volume(object):
    ...
    def update(self, prefix_path, name, vpool, transferspeed):
        '''
        Makes REST API call to update a volume information
        Parameters:
            name: name of the volume to be updated
            vpool: name of vpool
            transfer-speed: Optional value, can be defined to set the transfer speed for migration
        Returns
            Created task details in JSON response payload
        '''
        namelist = []
...
def update_parser(subcommand_parsers, common_parser):
    ...
    mandatory_args.add_argument('-vpool', '-vp',
                                ...
                                dest='vpool',
                                required=True)
    update_parser.add_argument('-transferspeed', '-trnspd',
                               metavar='<transferspeed>',
                               dest='transferspeed',
                               help='Specify the transfer speed')
