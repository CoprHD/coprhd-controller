...
@Service("VMware-CreateVVolDatastore")
public class CreateVVolDatastoreService extends VMwareHostService {
    ...
    public void execute() throws Exception {
        ...
        Datastore datastore = vmware.createVVOLDatastore(host, cluster, volume, datastoreName);
