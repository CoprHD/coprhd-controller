...
public class VirtualMachineMapper {
    ...
    public static ExportGroupRestRep map(ExportGroup from, List<Initiator> initiators,
            Map<String, Integer> volumes, List<VirtualMachine> vms, List<Cluster> clusters,
    ...
    public static VirtualMachineRestRep map(VirtualMachine from) {
        if (from == null) {
            return null;
        }
        VirtualMachineRestRep to = new VirtualMachineRestRep();
