...
public class LoggingFilterTest {
    public static final String SOMETHING_WITH_PASSWORDS = "<password>MYPASSWORD</password>";// NOSONAR
                                                                                            // ("Suppressing Sonar violation of Field names should comply with naming convention, also this field  is not holding sensitive data")
    public static final String SOMETHING_WITH_PASSWORD_MAP = "<map><key>password</key><value>MYPASSWORD</value></map>"; // NOSONAR
                                                                                                                        // ("Suppressing Sonar violation of Field names should comply with naming convention, also this field  is not holding sensitive data")
