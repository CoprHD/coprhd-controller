...
/**
 * This class is used to fetch DB repair status from ZK, don't need to attach to local dbsvc process
 *
 */
public class RepairStatusManager {
    ...
    private RecoveryStatus queryNodeRecoveryStatus() {
        ...
        Configuration cfg = coordinator.queryConfiguration(Constants.NODE_RECOVERY_STATUS,
                Constants.GLOBAL_ID);
        if (cfg != null) {
