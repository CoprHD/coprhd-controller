...
public class ResynchronizeSnapshotForApplication extends WaitForTasks<TaskResourceRep> {
    private final URI applicationId;
    private final List<URI> snapshots;

    public ResynchronizeSnapshotForApplication(URI applicationId, List<URI> snapshots) {
