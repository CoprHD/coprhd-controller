...
public class RecoverPointImageManagementUtils {
	 ...
	 * @throws RecoverPointException
	 **/
	private void recoverProductionAndWait(FunctionalAPIImpl impl, ConsistencyGroupCopyUID groupCopy) throws FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, RecoverPointException, InterruptedException
	{
	 ...
	 **/
	private boolean waitForEnableToComplete(FunctionalAPIImpl port, ConsistencyGroupCopyUID groupCopy, ImageAccessMode accessMode, TimeFrame timeFrame)
			throws FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, InterruptedException, RecoverPointException {
	 ...
	 * @throws RecoverPointException, FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, InterruptedException
	 **/
	private boolean verifyGroupCopyImageIsEnabled(FunctionalAPIImpl port, ConsistencyGroupCopyUID groupCopy, boolean expectLoggedAccess, String bookmarkName)
	 ...
	 * @throws RecoverPointException, FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, InterruptedException
	 **/
	private boolean isGroupCopyImageEnabledForAPIT(FunctionalAPIImpl port, ConsistencyGroupCopyUID groupCopy, boolean expectLoggedAccess, RecoverPointTimeStamp apitTime)
	throws FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, RecoverPointException {
		ConsistencyGroupUID groupUID = groupCopy.getGroupUID();
		ConsistencyGroupState groupState;
		List<ConsistencyGroupCopyState> groupCopyStateList;
		...
		for (ConsistencyGroupCopyState groupCopyState : groupCopyStateList) {
			if (RecoverPointUtils.cgCopyEqual(groupCopyState.getCopyUID(), groupCopy)) {
				...
				if (apitTime != null) {
					...
					// requested APIT time is the one we are looking for. Limit the snaps we look at to 1 hour before/after requested APIT time
					//
	 ...
	 * @throws RecoverPointException, FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, InterruptedException
	 **/
	private void waitForCGCopyState(FunctionalAPIImpl port, ConsistencyGroupCopyUID groupCopy, ImageAccessMode accessMode, boolean expectRollComplete)
			throws FunctionalAPIActionFailedException_Exception, FunctionalAPIInternalError_Exception, InterruptedException, RecoverPointException {
		ConsistencyGroupUID groupUID = groupCopy.getGroupUID();
		List<ConsistencyGroupCopyState> groupCopyStateList;
	 ...
	 * @throws RecoverPointException
	 */
	public boolean verifyCopyCapableOfEnableImageAccess(FunctionalAPIImpl impl, ConsistencyGroupCopyUID cgCopy, boolean failover) throws RecoverPointException {
		String cgCopyName = NAME_UNKNOWN;
		String cgName = NAME_UNKNOWN;
	...
	public ConsistencyGroupLinkState getCopyLinkState(FunctionalAPIImpl impl, ConsistencyGroupCopyUID cgCopy) throws RecoverPointException {
		...
		try {
			...
			for (ConsistencyGroupLinkState cgLinkState : linkStates) {
				if ((RecoverPointUtils.cgCopyEqual(cgLinkState.getGroupLinkUID().getSecondCopy(), cgCopy.getGlobalCopyUID()) ||
					(RecoverPointUtils.cgCopyEqual(cgLinkState.getGroupLinkUID().getFirstCopy(), cgCopy.getGlobalCopyUID())))) {
					return cgLinkState;
				}
			}
			return null;
