...
public class CopyOfDbConsistencyCheckerHelper {
    private static final Logger _log = LoggerFactory.getLogger(CopyOfDbConsistencyCheckerHelper.class);
    ...
    public CopyOfDbConsistencyCheckerHelper() {
    }

    public CopyOfDbConsistencyCheckerHelper(DbClientImpl dbClient) {
