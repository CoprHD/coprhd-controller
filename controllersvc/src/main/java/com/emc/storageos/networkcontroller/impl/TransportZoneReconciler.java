...
public class TransportZoneReconciler {
	 ...
	 * <li>The fabric still exists but under a new WWN (case when principal
	 * switch changes or fragmentation)</li>
	 * <li>The fabric was discovered while fragmented and assumed to be an
	 * isolated fabric but now it is merging again and so, for all practical
	 * purposes, the old WWN should be removed</li>
	 * </ol>
	 * 
	 * @param tzone
