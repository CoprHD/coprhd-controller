Feature: Allow Customer to select RDF Group as part of the Create block volume and VMware Datastore catalog service
  ...
  Scenario Outline: Test various combinations of volume creation via Create block volume and VMware Datastore.
    When they order a volume and VMware datastore using the Create Volume and VMware Datastore catalog service
