...
/**
 * <p>Java class for InactiveProvider complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InactiveProvider">
 *   &lt;complexContent>
...
@XmlType(name = "InactiveProvider", namespace = "http://fault.vasa.vim.vmware.com/xsd", propOrder = {
    "entityId",
    "entityType"
})
    ...
    extends Exception
{
    ...
    @XmlElementRef(name = "entityId", namespace = "http://fault.vasa.vim.vmware.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> entityId;
    @XmlElementRef(name = "entityType", namespace = "http://fault.vasa.vim.vmware.com/xsd", type = JAXBElement.class, required = false)
