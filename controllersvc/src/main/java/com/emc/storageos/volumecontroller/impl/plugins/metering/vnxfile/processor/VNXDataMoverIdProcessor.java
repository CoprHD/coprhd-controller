 ...
 */
public class VNXDataMoverIdProcessor extends VNXFileProcessor {

    private final Logger _logger = LoggerFactory.getLogger(VNXDataMoverIdProcessor.class);
    ...
    public void processResult(Operation operation, Object resultObj,
        ...
        try {
            ...
            _logger.error(
                    "Exception occurred while processing the vnx data mover due to {}",
                    ex.getMessage());
