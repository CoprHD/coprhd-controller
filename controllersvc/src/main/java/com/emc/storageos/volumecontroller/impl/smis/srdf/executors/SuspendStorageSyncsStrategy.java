 ...
 */
public class SuspendStorageSyncsStrategy implements ExecutorStrategy {

    private SmisCommandHelper helper;

    public SuspendStorageSyncsStrategy(SmisCommandHelper helper) {
        this.helper = helper;
    }

    @Override
    public void execute(Collection<CIMObjectPath> objectPaths, StorageSystem provider) throws WBEMException {
        CIMArgument[] args = helper.getSRDFPauseLinkInputArguments(objectPaths, null, false);
