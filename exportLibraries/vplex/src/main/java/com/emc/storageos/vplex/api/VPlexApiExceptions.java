 ...
 * VPlexApiExceptions.properties and use the annotation {@link DeclareServiceCode}
...
public interface VPlexApiExceptions {
    ...
    @DeclareServiceCode(ServiceCode.VPLEX_API_ERROR)    public VPlexApiException failedToFindAllRequestedTargets();
    @DeclareServiceCode(ServiceCode.VPLEX_API_ERROR)    public VPlexApiException couldNotFindStorageView(String viewName);
