...
public class RestoreStorageActiveSyncsStrategy implements ExecutorStrategy {

    private SmisCommandHelper helper;

    public RestoreStorageActiveSyncsStrategy(SmisCommandHelper helper) {
        this.helper = helper;
    }

    @Override
    public void execute(Collection<CIMObjectPath> objectPaths, StorageSystem provider) throws WBEMException {
        CIMArgument[] args = helper.getActiveSRDFRestoreInputArguments(objectPaths);
