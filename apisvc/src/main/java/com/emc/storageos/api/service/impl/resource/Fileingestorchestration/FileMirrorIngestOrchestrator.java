 ...
 */
public class FileMirrorIngestOrchestrator extends FileIngestOrchestrator {
    private static final Logger _logger = LoggerFactory.getLogger(FileMirrorIngestOrchestrator.class);
