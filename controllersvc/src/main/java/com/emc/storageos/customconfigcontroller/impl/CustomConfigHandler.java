...
public class CustomConfigHandler {
     ...
     * this cannot be found then the system default defined
     * {@link CustomConfigType}
     ...
     * @param name the configuration type name 
     * @param scope the scope to be used to find the configuration value. See 
     * {@link #getCustomConfigValue(String, StringMap)} for details.
     ...
     * configuration is valid. <ol>
     * <li>if isCheckDuplicate is set to true, ensure that a user-created configuration
     *      does not already exist for this configuration type and scope</li>
     * <li>check that a configuration type exists for the name</li>
     * <li>check that the scope is supported based on the definition of the scope
     *     in the type of this configuration</li>
     * <li>check that the value is of the right type and that it is compliant with
     *     the constraints defined for this configuration type</li>
     * </ol>
     * @param name the configuration type name 
    ...
    public void loadSystemCustomConfigs() {
        ...
        CustomConfig curConfig = null; CustomConfig newConfig = null;
