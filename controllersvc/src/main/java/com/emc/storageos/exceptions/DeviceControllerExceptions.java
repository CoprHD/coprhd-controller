 ...
 * {@link DeviceControllerException}s
 * <p/>
 * Remember to add the English message associated to the method in
 * DeviceControllerExceptions.properties and use the annotation
...
public interface DeviceControllerExceptions {
    ...
    @DeclareServiceCode(ServiceCode.BLOCK_CONTROLLER_ERROR)
    public DeviceControllerException existingExportFoundButNotEnoughPortsToSatisfyMinPaths(String maskName, String totalPorts, String exportPathParam);
