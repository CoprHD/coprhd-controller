...
public class ClientConfig {
	...
	public static String KEYSTORE_PWD =  "keyStorePassword"; //NOSONAR (retaining hard-coded password)
	...
	public static final String PWD = "password"; //NOSONAR (retaining hard-coded password)
