...
class License {
    public static final String CONTROLLER_FEATURE = "ViPR_Controller"
    public static final String OBJECT_FEATURE = "ViPR_Object"
    
    public static final String LICENSE = """
INCREMENT ViPR_Block EMCLM 2.0 permanent uncounted \
