 ...
 */
public class FileSnapIngestOrchestrator extends FileIngestOrchestrator {
    private static final Logger _logger = LoggerFactory.getLogger(FileSnapIngestOrchestrator.class);
