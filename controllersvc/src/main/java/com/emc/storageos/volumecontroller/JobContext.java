...
public class JobContext
{
    ...
    private NetAppCApiClientFactory _netAppCApiClientFactory = null;
    ...
    public JobContext(DbClient dbClient, CIMConnectionFactory cimConnectionFactory,
            ...
            XIVSmisCommandHelper xivHelper, IsilonApiFactory isilonApiFactory, NetAppCApiClientFactory netAppCApiClientFactory) {
        _dbClient = dbClient;
        ...
        this._netAppCApiClientFactory = netAppCApiClientFactory;
    ...
    public NetAppCApiClientFactory getNetAppCApiClientFactory() {
        return _netAppCApiClientFactory;
    }
}