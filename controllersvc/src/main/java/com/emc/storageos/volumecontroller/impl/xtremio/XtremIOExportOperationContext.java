...
/**
 * Class the keeps track of the operations that are in flight for XtremIO exports
 */
public class XtremIOExportOperationContext extends ExportOperationContext implements Serializable {
    ...
    public static final String OPERATION_ADD_LUN_MAP_TO_INITIATOR_GROUP = "Add volumes to storage group";
