...
public class ControllerServiceImpl implements ControllerService {
    ...
    private NetAppCApiClientFactory netAppCApiClientFactory;
    ...
    public void start() throws Exception {
        ...
        _jobTracker
                .setJobContext(new JobContext(_dbClient, _cimConnectionFactory,
                        ...
                        isilonApiFactory, netAppCApiClientFactory));
        _jobTracker.start();
    ...
    public NetAppCApiClientFactory getNetAppCApiClientFactory() {
        return netAppCApiClientFactory;
    }

    public void setNetAppCApiClientFactory(NetAppCApiClientFactory netAppCApiClientFactory) {
        this.netAppCApiClientFactory = netAppCApiClientFactory;
    }
