...
public enum ServiceCode {
    ...
    SYS_DR_CONFIG_STANDBY_FAILED(30044),
    SYS_DR_REMOVE_STANDBY_FAILED(30045),
    SYS_DR_PAUSE_STANDBY_FAILED(30046),
    SYS_DR_ADD_STANDBY_TIMEOUT(30047),
    SYS_DR_REMOVE_STANDBY_RECONFIG_FAIL(30048),
    SYS_DR_SWITCHOVER_PRECHECK_FAILED(30049),
    SYS_DR_SWITCHOVER_FAILED(30050),
    SYS_DR_SWITCHOVER_FAILED_TIMEOUT(30051),
