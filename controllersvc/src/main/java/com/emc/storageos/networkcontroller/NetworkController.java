...
public interface NetworkController extends Controller {
   ...
   public void discoverNetworkSystems(AsyncTask[] tasks) throws
     ...
     * @throws InternalException
     */
    public void updateSanZones(URI network, String fabricId, String fabricWwn, List<ZoneUpdate> zones, boolean activateZones, String taskId) 
            throws InternalException;    
    ...
    /**
     * Asynchronous call to remove aliases from a specified fabric of a given network system.  If network system is a MDS, ignore fabricId, and
