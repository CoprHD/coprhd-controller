...
public class HDSExportMaskVolumesValidator extends AbstractHDSValidator {

    private static final Logger log = LoggerFactory.getLogger(HDSExportMaskVolumesValidator.class);

    public HDSExportMaskVolumesValidator(StorageSystem storage, ExportMask exportMask, HDSSystemValidatorFactory factory,
