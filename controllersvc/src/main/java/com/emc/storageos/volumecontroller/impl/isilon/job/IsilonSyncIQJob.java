...
public class IsilonSyncIQJob extends Job implements Serializable {
    ...
    public IsilonSyncIQJob(URI storageSystemUri, TaskCompleter taskCompleter) {
        this._storageSystemUri = storageSystemUri;
        this._taskCompleter = taskCompleter;
    }
    ...
    public JobPollResult poll(JobContext jobContext, long trackingPeriodInMillis) {
        ...
        try {
            ...
            if (isiApiClient == null) {
                ...
                _logger.error("IsilonSyncIQJob:poll {} failed; Details: {}", currentJob, policy.toString());
                ...
                if (policyState.equals(JobState.running)) {
                    ...
                    _errorDescription = isiGetReportErrMsg(isiApiClient.getReplicationPolicyReports(policy.getName()).getList());
                    _pollResult.setJobPercentComplete(100);
