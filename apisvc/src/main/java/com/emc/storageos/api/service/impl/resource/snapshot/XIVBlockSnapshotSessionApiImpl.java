...
/**
 * Block snapshot session implementation for volumes on XIV systems.
 */
public class XIVBlockSnapshotSessionApiImpl extends DefaultBlockSnapshotSessionApiImpl {

    /**
     * Private default constructor should not be called outside class.
     */
    @SuppressWarnings("unused")
    private XIVBlockSnapshotSessionApiImpl() {
        super();
    }
     ...
     */
    public XIVBlockSnapshotSessionApiImpl(DbClient dbClient, CoordinatorClient coordinator, PermissionsHelper permissionsHelper,
