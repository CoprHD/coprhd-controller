...
public interface VMAXConstants {
    ...
    public static final String CUTOVER_MIGRATION = "Cutover migration";
    public static final String COMMIT_MIGRATION = "Commit migration";
    public static final String CANCEL_MIGRATION = "Cancel migration";
    public static final String REFRESH_MIGRATION = "Refresh migration";
