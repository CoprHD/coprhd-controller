...
public class ComputeImageServerList {
    ...
    public ComputeImageServerList(List<NamedRelatedResourceRep> computeImageServers) {
    ...
    public void setComputeImageServers(List<NamedRelatedResourceRep> computeImageServers) {
        this.computeImageServers = computeImageServers;
    }
}
