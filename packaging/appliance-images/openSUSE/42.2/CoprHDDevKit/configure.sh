...
{
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-oss \
         --no-gpgcheck http://download.opensuse.org/distribution/leap/42.2/repo/oss/suse suse-42.2-oss
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-oss-update \
         --no-gpgcheck http://download.opensuse.org/update/leap/42.2/oss suse-42.2-oss-update
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-monitoring \
         --no-gpgcheck http://download.opensuse.org/repositories/server:/monitoring/openSUSE_Leap_42.2 suse-42.2-monitoring
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-http \
         --no-gpgcheck http://download.opensuse.org/repositories/server:/http/openSUSE_Leap_42.2 suse-42.2-http
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-seife \
         --no-gpgcheck http://download.opensuse.org/repositories/home:/seife:/testing/openSUSE_Leap_42.2 suse-42.2-seife
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-python \
         --no-gpgcheck http://download.opensuse.org/repositories/devel:/languages:/python/openSUSE_Leap_42.2 suse-42.2-python
  zypper --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-network \
  ...
  zypper --non-interactive --no-gpg-checks modifyrepo --priority  3 suse-42.2-oss
  zypper --non-interactive --no-gpg-checks modifyrepo --priority  3 suse-42.2-oss-update
  zypper --non-interactive --no-gpg-checks modifyrepo --priority 99 suse-42.2-non-oss
  zypper --non-interactive --no-gpg-checks modifyrepo --priority  1 suse-42.2-monitoring
  zypper --non-interactive --no-gpg-checks modifyrepo --priority  1 suse-42.2-http
  zypper --non-interactive --no-gpg-checks modifyrepo --priority  1 suse-42.2-seife
...
function installPackages
{
  ...
  cp -f /etc/zypp/repos.d/suse-42.2-oss.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-monitoring.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-http.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-python.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-network.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-seife.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-containers.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.3-filesystems-ceph.repo /tmp/coprhd.d/
  cp -f /etc/zypp/repos.d/suse-42.2-electronics.repo /tmp/coprhd.d/

  ISO=$(mount | grep openSUSE-Leap-42.2-DVD-x86_64.iso | cut -d ' ' -f 3)
  if [ ! -z "${ISO}" ]; then
    zypper --reposd-dir=/tmp/coprhd.d --non-interactive --no-gpg-checks addrepo --no-check --name suse-42.2-iso \
           --no-gpgcheck ${ISO} suse-42.2-iso
    zypper --reposd-dir=/tmp/coprhd.d --non-interactive --no-gpg-checks modifyrepo --priority 2 suse-42.2-iso
  fi

  zypper --reposd-dir=/tmp/coprhd.d --non-interactive --no-gpg-checks refresh
  zypper --reposd-dir=/tmp/coprhd.d --non-interactive --no-gpg-checks install --details --no-recommends --force-resolution ant apache2-mod_perl apache2-prefork atop bind-libs bind-utils ca-certificates-cacert ca-certificates-mozilla curl createrepo dhcp dhcp-client dhcp-server docker docker-compose expect fontconfig fonts-config gcc-c++ GeoIP GeoIP-data git git-core glib2-devel gpgme grub2 ifplugd inst-source-utils iproute2 iputils java-1_7_0-openjdk java-1_7_0-openjdk-devel java-1_8_0-openjdk java-1_8_0-openjdk-devel keepalived kernel-default kernel-default-devel kernel-source kiwi kiwi-desc-isoboot kiwi-desc-oemboot kiwi-desc-vmxboot kiwi-templates libaudiofile1 libesd0 libgcrypt-devel libGeoIP1 libgpg-error-devel libmng1 libopenssl-devel libpcrecpp0 libpcreposix0 libqt4 libqt4-sql libqt4-x11 libSDL-1_2-0 libserf-devel libtool libuuid-devel libvpx1 libxml2-devel libXmu6 lvm2 make mkfontdir mkfontscale mozilla-nss-certs netcfg net-tools ndisc6 nfs-client nginx openssh openssh-fips p7zip pam-devel parted pcre-devel perl-Config-General perl-Error perl-Tk plymouth python-cjson python-devel python-gpgme python-iniparse python-libxml2 python-py python-requests python-setools qemu qemu-tools readline-devel regexp rpm-build setools-libs sipcalc sshpass strongswan strongswan-ipsec strongswan-libs0 subversion sudo SuSEfirewall2 sysconfig sysconfig-netconfig syslinux sysstat systemd-logger tar telnet unixODBC vim virtualbox virtualbox-host-kmp-default wget xbitmaps xfsprogs xml-commons-jaxp-1.3-apis xmlstarlet xorg-x11-essentials xorg-x11-fonts xorg-x11-server xz-devel zlib-devel boost-license1_58_0 libboost_system1_58_0 libboost_thread1_58_0 librados2 librbd1 containerd runc ansible python-Jinja2 python-MarkupSafe
  rm -fr /tmp/coprhd.d
  ...
  zypper --reposd-dir=/tmp/coprhd.d --non-interactive --no-gpg-checks refresh
  # package updates from the repo above (suse-42.2-oss-update)
