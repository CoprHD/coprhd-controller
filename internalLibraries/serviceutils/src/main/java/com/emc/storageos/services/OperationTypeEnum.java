...
public enum OperationTypeEnum {
    ...
    SET_TENANT_NAMESPACE("Set Tenant NS", "", "Tenant namespace info is updatd."),
    ...
    ESTABLISH_VOLUME_SNAPSHOT("VolumeSnapshotGroupEstablished", "VolumeSnapshotGroupEstablishFailed", "Volume snapshot group establish is performed."),
    CHANGE_VOLUME_VPOOL("VolumeVPoolChanged", "VolumeVPoolChangeFailed", "Volume has changed virtual pool."),
    CHANGE_VOLUME_AUTO_TIERING_POLICY("VolumeAutoTieringPolicyChanged", "VolumeAutoTieringPolicyChangeFailed",
            "Volume has changed auto-tiering policy."),
    ...
    CHANGE_SRDF_COPYMODE("SRDFCopyModeChanged", "SRDFCopyModeChangeFailed", "SRDF copy code is changed."),
    ...
    FAILOVER_TEST_RP_LINK("RPLinkTestFailedOver", "RPLinkTestFailOverFailed", "RP link is failed over in test mode."),
    ...
    ESTABLISH_VOLUME_MIRROR("VolumeMirrorGroupEstablished", "VolumeMirrorGroupEstablishFailed", "Volume mirror group sstablish is performed."),
    ...
    ESTABLISH_VOLUME_FULL_COPY("VolumeFullCopyGroupEstablished", "VolumeFullCopyGroupEstablishFailed", "Volume full copy group establish is performed."),
    ...
    UNDO_RELEASE_FILE_SYSTEM("FileSystemReleaseUndone", "", "File system is release undone."),
    CHANGE_FILE_SYSTEM_VPOOL("ChangeFileSystemVpool", "ChangeFileSystemVpoolFailed", "File system virtual pool is changed."),
    ...
    DELETE_FILE_SYSTEM_SHARE("FileSystemShareDeleted", "FileSystemShareDeleteFailed", "File system is share deleted."),
    ...
    OPERATE_BLOCK_VOLUME("VolumeEventOkStatus", "VolumeEventNotOkStatus", "Volume operation is performed."),
    OPERATE_FILE_SYSTEM("FileSystemEventOkStatus", "FileSystemEventNotOkStatus", "File system operation is performed."),
    ...
    DELETE_NAMESPACE("DELETE NAMESPACE", "", "Namespace is deleted."), // left off here
    ...
    UNSET_VARRAY_PROTECTIONTYPE("UNSET VARRAY PROTECTION TYPE", "", "Vritual array protection type is unassigned."),
    ...
    DELETE_SWIFT_CONTAINER("DELETE SWIFT CONTAINER", "", "Switft container is deleted."),
    ...
    PERFORM_PROTECTION_OPERATION("PERFORM PROTECTION OPERATION", "", "Protection operation is performed."),
    DISCOVER_PROTECTION_SET("DISCOVER_PROTECTION_SET", "", "Protection set is discovered."),
    PERFORM_PROTECTION_ACTION("PERFORM PROTECTION ACTION", "", "Protection operation is performed."),
    ...
    DOWNLOAD_ORDER("DOWNLOAD ORDER", "", "Order is downloaded."),
    ...
    DELETE_VCENTER_DATACENTER("DELETE VCENTER DATACENTER", "", "Vcenter data center is deletted."),
    ...
    REGISTER_COMPUTE_SYSTEM("REGISTER COMPUTE SYSTEM", "", "Compute system is regiestered."),
    ...
    UPDATE_VERSION("UPDATE VERSION", "", "Version update is performed."),
    INSTALL_IMAGE("INSTALL IMAGE", "", "Image installation is performed."),
    REMOVE_IMAGE("REMOVE IMAGE", "", "Image removal is performed."),
    UPLOAD_IMAGE("UPLOAD IMAGE", "", "Imgage upload is performed."),
    WAKEUP_UPGRAGE_MANAGER("WAKEUP UPGRADE MANAGER", "", "Upgrade manager wake-up is performed."),
    UPDATE_SYSTEM_PROPERTY("UPDATE SYSTEM PROPERTY", "", "Update system property is updated."),
    SEND_ALERT("SEND ALERT", "", "Alert is sent."),
    SEND_REGISTRATION("SEND ALERT", "", "Registration is sent."),
    SEND_HEARTBEAT("SEND HEARTBEAT", "", "Heartbeat signal is sent."),
    ...
    SCHEDULE_EVENT("SCHEDULE EVENT", "", "Schedule event is performed."),
    ...
    UPDATE_TRUSTED_CERTIFICATES_PARTIAL("UPDATE TRUSTED CERTIFICATES PARTIAL SUCCESS", "",
            "Trusted certificates are partially successful updating."),
    ...
    UPDATE_FILE_SYSTEM_SHARE_ACL("UPDATE FILE SHARE ACL", "", "File system share ACL has been updated."),
    UPDATE_FILE_SNAPSHOT_SHARE_ACL("UPDATE SNAPSHOT SHARE ACL", "", "File system snapshot share ACL has been updated."),
    DELETE_FILE_SYSTEM_SHARE_ACL("DELETE FILE SHARE ACL", "", "File system share ACL has been deleted."),
    DELETE_FILE_SNAPSHOT_SHARE_ACL("DELETE SNAPSHOT SHARE ACL", "", "File system snapshot share ACL has been deleted."),
    UPDATE_FILE_SYSTEM_NFS_ACL("UPDATE FILE NFS ACL", "", "NFS file system ACL has been updated."),
    UPDATE_FILE_SNAPSHOT_NFS_ACL("UPDATE SNAPSHOT NFS ACL", "", "NFS file system snapshot ACL has been updated."),
    DELETE_FILE_SYSTEM_NFS_ACL("DELETE FILE NFS ACL", "", "NFS File system ACL has been deleted."), 
    DELETE_FILE_SNAPSHOT_NFS_ACL("DELETE SNAPSHOT NFS ACL", "", "NFS File system snapshot has been deleted."),
    ...
    ADD_JOURNAL_VOLUME("ADD JOURNAL VOLUME", "", "Journal volume is aded."),
    ArrayGeneric("", "", ""),
    ...
    SWITCHOVER("SWITCHOVER TO A STANDBY", "", "Standby site switchover is initiated."),
    ...
    STANDBY_REJOIN("STANDBY REJOIN VDC FROM STANDBY_DEGRADED STATE", "",
            "Rejoined virtual data center ROM degraded state for standby site is marked."),
    ...
    EXPORT_PATH_ADJUSTMENT("EXPORT PATH ADJUSTMENT", "", "Export path adjustment is performed."),
    /* Filesystem Mount Operations*/
    MOUNT_NFS_EXPORT("MOUNT NFS EXPORT", "mount nfs export operation failed", "NFS export has been mounted."),
    UNMOUNT_NFS_EXPORT("UNMOUNT NFS EXPORT", "unmount nfs operation failed", "NFS export has been unmounted."),
    LIST_MOUNTED_EXPORTS("LIST MOUNTED EXPORTS", "list mounted nfs operation failed", "Mounted exports have been retrieved."),

    DELETE_FILE_POLICY("DELETE FILE POLICY", "Delete file policy failed", "File policy has been deleted."),
    UNASSIGN_FILE_POLICY("FilePolicyUnassign", "FilePolicyUnassignFailed", "File policy has been unassigned."),
