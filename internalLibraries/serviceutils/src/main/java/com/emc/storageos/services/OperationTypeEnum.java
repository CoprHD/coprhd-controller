...
public enum OperationTypeEnum {
    ...
    CHANGE_VOLUME_AUTO_TIERING_POLICY   ("VolumeAutoTieringPolicyChanged",     "VolumeAutoTieringPolicyChangeFailed",     "Volume Auto-tiering Policy Change"),
    ...
    RESTORE_CONSISTENCY_GROUP_SNAPSHOT     ("ConsistencyGroupSnapshotRestored",     "ConsistencyGroupSnapshotRestoreFailed",      "ConsistencyGroupSnapshot Restore"),
    DEACTIVATE_CONSISTENCY_GROUP_SNAPSHOT  ("ConsistencyGroupSnapshotDeactivated",	"ConsistencyGroupSnapshotDeactivateFailed",   "ConsistencyGroupSnapshot Deactivate"),
    ACTIVATE_CONSISTENCY_GROUP_SNAPSHOT  ("ConsistencyGroupSnapshotActivated",	"ConsistencyGroupSnapshotActivateFailed",   "ConsistencyGroupSnapshot Activate"),
    ...
    UPDATE_EXPORT_RULES_FILE_SNAPSHOT	("FileSystemSnapshotExportRulesUpdated", 	"FileSystemSnapshotExportRulesUpdateFailed","FileSystem snapshot export rules updated"),
    ...
    UPDATE_AUTHPROVIDER_GROUP_ATTR  ("UPDATE AUTH PROVIDER GROUP ATTR",  "",  "operation to update a authentication provider's group attribute.  This may affect existing tenants, project acls and role assignments."),
    ...
    PREPARE_VDC                      ("PREPARE VDC",               "",   "operation to prepare a vdc for GEO scenario. Root user TENANT_ADMIN and project ownerships will be removed."),
    ...
    UPDATE_TRUSTED_CERTIFICATES_PARTIAL ("UPDATE TRUSTED CERTIFICATES PARTIAL SUCCESS", "", "operation to update ViPR's trusted certificates succeeded partially"),
    ...
    SEND_PASSWORD_TO_BE_EXPIRE_MAIL ("SEND PASSWORD TO BE EXPIRED MAIL SUCCESS", "SEND PASSWORD TO BE EXPIRED MAIL FAIL", "operation to send password to be expired mail"),
