...
public class UCSMSession implements ComputeSession{
    ...
    private void attemptSessionRefresh() throws ClientGeneralException {
        try{
            ...
            if(refreshResponse != null && refreshResponse.getOutCookie() != null && !refreshResponse.getOutCookie().isEmpty()){
                ...
                cache = new ComputeSessionCache(refreshResponse.getOutCookie(),System.currentTimeMillis(),parseNumber(refreshResponse.getOutRefreshPeriod()).longValue(),oneWayHash);
    ...
    public ComputeSessionCache decryptAndRetrieveSessionCache() throws ClientGeneralException{
        ...
        try{
            ...
            if(zkdata!=null) cache  = (ComputeSessionCache)zkdata;
    ...
    private void initializeSession() {
        distributedDataManager = coordinator.createDistributedDataManager(ComputeSessionUtil.Constants.COMPUTE_SESSION_BASE_PATH.toString());
    }
