 ...
 *
 */
public class RecoverApplicationMigration extends WaitForTasks<TaskResourceRep> {
     ...
     */
    public RecoverApplicationMigration(URI mobilityGroupId) {
        super();
    ...
    protected Tasks<TaskResourceRep> doExecute() throws Exception {
        TaskList taskList = getClient().application().recoverMigration(mobilityGroupId);
