 ...
 *
 */
public class RemoveApplicationMigrationEnv extends WaitForTasks<TaskResourceRep> {
     ...
     */
    public RemoveApplicationMigrationEnv(URI mobilityGroupId) {
        super();
    ...
    protected Tasks<TaskResourceRep> doExecute() throws Exception {
        TaskList taskList = getClient().application().removeEnvMigration(mobilityGroupId);
