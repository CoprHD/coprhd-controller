...
public class StorageSystemTypeAddParam {
    ...
    /**
     * Storage System Type ID internal URI generated by system for unique
     * identification
     *
     */
    ...
    /**
     * Is this Storage System Type is managed using SMI Provider. If true CoprHD
     * should connect through Provider only
     */
    ...
    /**
     * Storage system type support SSL connection by default. If true provide
     * SSL port
     */
    ...
    /**
     * Is the storage system type support Meta Data Manager as default. This is
     * applicable only for ScaleIO arrays
     */
    ...
    /**
     * Is the storage system type support only Meta Data Manager. This is
     * applicable only for ScaleIO arrays
     */
    ...
    /**
     * Whether the Storage System Type is managed by Element Manager. Applicable
     * for ScaleIO
     */
    ...
    /**
     * Storage System Type driver class name. This class is defined in South
     * Bound SDK of CoprHD that device driver developer should implement.
     */
