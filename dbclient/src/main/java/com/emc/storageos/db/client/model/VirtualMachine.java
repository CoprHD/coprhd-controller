 ...
 */
@Cf("VirtualMachine")
public class VirtualMachine extends AbstractComputeSystem {
    ...
    /**
     * Sets the short or fully qualified vm name or an IP address
     * 
     * @param hostName the host name
     */
    public void setVMName(String vmName) {
        this._vmName = EndpointUtility.changeCase(vmName);
        setChanged("vmName");
    }
    ...
    /**
     * The expected list of VM OS types
     * 
     */
