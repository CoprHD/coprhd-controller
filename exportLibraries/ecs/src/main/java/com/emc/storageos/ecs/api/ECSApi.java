...
public class ECSApi {
    ...
    public ECSNamespaceRepGroup getNamespaceDetails(String namespaceId) throws ECSException {
        ...
        try {
            ...
            nsRepGroup.setRgType(ObjectNamespace.ECS_RepGroup_Type.NONE);
            ...
            if (ecsNsResult.getAllowed_vpools_list().size() != 0) {
                ...
                nsRepGroup.setRgType(ObjectNamespace.ECS_RepGroup_Type.ALLOWED);
                ...
                nsRepGroup.setRgType(ObjectNamespace.ECS_RepGroup_Type.DISALLOWED);
            }
            return nsRepGroup;
        } catch (Exception e) {
