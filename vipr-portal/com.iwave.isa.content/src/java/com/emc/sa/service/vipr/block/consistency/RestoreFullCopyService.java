...
import static com.emc.sa.service.vipr.block.consistency.ConsistencyUtils.restoreFullCopy;
...
@Service("ConsistencyGroupRestoreFullCopy")
public class RestoreFullCopyService extends ViPRService {
    ...
    public void execute() throws Exception {
        for (URI copyId : uris(copyIds)) {
            restoreFullCopy(consistencyGroupId, copyId);
        }
    }
}
