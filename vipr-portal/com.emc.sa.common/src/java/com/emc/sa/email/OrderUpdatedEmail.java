...
public class OrderUpdatedEmail extends CatalogEmail {
    ...
    public OrderUpdatedEmail(Order order, CatalogService catalogService, ApprovalRequest approvalRequest, String virtualIp) {
        setTitle(messages.get("notification.orderUpdated.title", order.getOrderStatus()));
    ...
    private static String readEmailTemplate() {
        return readTemplate("OrderUpdatedEmail.html");
    }
