 ...
 *         &lt;element name="newContainerId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "cloneVirtualVolume")
public class CloneVirtualVolume {

    @XmlElement(required = true)
    protected String vvolId;
    @XmlElementRef(name = "newContainerId", namespace = "http://com.vmware.vim.vasa/2.0/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> newContainerId;
    ...
    /**
     * Gets the value of the newContainerId property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getNewContainerId() {
        return newContainerId;
    }

    /**
     * Sets the value of the newContainerId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setNewContainerId(JAXBElement<String> value) {
        this.newContainerId = value;
    }
