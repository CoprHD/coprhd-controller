 ...
 */
public class DetachStorageSyncsStrategy implements ExecutorStrategy {
    private SmisCommandHelper helper;

    public DetachStorageSyncsStrategy(SmisCommandHelper helper) {
        this.helper = helper;
    }

    @Override
    public void execute(Collection<CIMObjectPath> objectPaths, StorageSystem provider) throws WBEMException {
        CIMArgument[] args = helper.getDetachSRDFInputArguments(objectPaths);
