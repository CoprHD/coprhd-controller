...
import static com.emc.sa.service.vipr.block.consistency.ConsistencyUtils.resynchronizeFullCopy;
...
@Service("ConsistencyGroupResynchronizeFullCopy")
public class ResynchronizeFullCopyService extends ViPRService {
	...
	public void execute() throws Exception {
		for (URI copyId : uris(copyIds)) {
			resynchronizeFullCopy(consistencyGroupId, copyId);
		}
	}
}
