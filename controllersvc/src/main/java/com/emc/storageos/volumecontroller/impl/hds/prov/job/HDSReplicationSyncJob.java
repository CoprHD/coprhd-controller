...
public class HDSReplicationSyncJob extends HDSJob {
    ...
    public enum ReplicationStatus {
        ...
        public boolean isErrorStatus() {
            return (this.getStatusCode() == ERROR.getStatusCode() || this.getStatusCode() == ERROR_IN_LUSE.getStatusCode());
        }
    }
    ...
    protected void processTransientError(long trackingInterval, String errorMessage, Exception ex) {
        ...
        log.info(String.format(
                "Tracking time of HDSReplicationSyncJob in transient error status - %s, Name: %s, source: %s, target: %s. Status %s .",
        ...
        if (getErrorTrackingTime() > ERROR_TRACKING_LIMIT) {
            ...
            log.error(String.format(
                    "Reached tracking time limit for HDSReplicationSyncJob - Name: %s, source: %s, target: %s. Set status to %s .",
    ...
    private void processPostProcessingError(long trackingInterval, String errorMessage, Exception ex) {
        ...
        log.info(String
                .format("Tracking time of HDSJob in post processing error - %s, Name: %s, source: %s, target: %s, Status: %s, PostProcessing status: %s .",
        ...
        if (postProcessingErrorTrackingTime > POST_PROCESSING_ERROR_TRACKING_LIMIT) {
            ...
            log.error(String
                    .format("Reached tracking time limit for HDSJob post processing - Name: %s, source: %s, target: %s, Set post processing status to %s .",
