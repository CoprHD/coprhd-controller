...
public class RequestAuditFilterTest {
    ...
    public static final String PASSWORD_IN_REQUEST = //NOSONAR ("Suppressing Sonar violation of Removeing this hard-coded password since it is default vipr's password")
