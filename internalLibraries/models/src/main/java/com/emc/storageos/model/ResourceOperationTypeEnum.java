...
public enum ResourceOperationTypeEnum {
    ...
    RENAME_VOLUME_AFTER_MIGRATION("RENAME_VOLUME", "rename volume"),
    ...
    ACTIVATE_VOLUME_GROUP_FULL_COPY("ACTIVATE VOLUME GROUP FULL COPY", "activate a volume group full copy"),
    DETACH_VOLUME_GROUP_FULL_COPY("DETACH VOLUME GROUP FULL COPY", "detach a volume group full copy"),
    RESTORE_VOLUME_GROUP_FULL_COPY("RESTORE VOLUME GROUP FULL COPY", "restore a volume group full copy"),
    RESYNCHRONIZE_VOLUME_GROUP_FULL_COPY("RESYNCHRONIZE VOLUME GROUP FULL COPY", "resynchronize a volume group full copy"),
