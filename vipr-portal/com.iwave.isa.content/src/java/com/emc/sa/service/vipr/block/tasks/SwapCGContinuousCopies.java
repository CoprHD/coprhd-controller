...
public class SwapCGContinuousCopies extends WaitForTasks<BlockConsistencyGroupRestRep> {
    ...
    public SwapCGContinuousCopies(URI consistencyGroupId, URI failoverTarget) {
        this(consistencyGroupId, failoverTarget, "rp");
    }

    public SwapCGContinuousCopies(URI consistencyGroupId, URI failoverTarget, String type) {
