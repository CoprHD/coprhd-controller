 ...
 */
public class SwapStorageSyncsStrategy implements ExecutorStrategy {
    private SmisCommandHelper helper;

    public SwapStorageSyncsStrategy(SmisCommandHelper helper) {
        this.helper = helper;
    }

    @Override
    public void execute(Collection<CIMObjectPath> objectPaths, StorageSystem provider) throws WBEMException {
        CIMArgument[] args = helper.getSwapPairSuspendInputArguments(objectPaths, null);
