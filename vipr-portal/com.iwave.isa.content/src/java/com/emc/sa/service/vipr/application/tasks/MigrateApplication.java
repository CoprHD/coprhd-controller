 ...
 *
 */
public class MigrateApplication extends WaitForTasks<TaskResourceRep> {
     ...
     */
    public MigrateApplication(URI mobilityGroupId) {
        super();
    ...
    protected Tasks<TaskResourceRep> doExecute() throws Exception {
        TaskList taskList = getClient().application().migrateMigration(mobilityGroupId);
