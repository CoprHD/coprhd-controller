...
/**
 * 
 * Model class for LogParam
 *
 */
@XmlRootElement(name = "log_param")
public class LogParam implements Serializable {
	private static final long serialVersionUID = -4692197065712750487L;
     ...
     *         ViPR node names
     * @param logNames
     *         logs obtained from different services
     * @param severity
     ...
     *          denotes the regex
     */
    public LogParam(List<String> nodeIds, List<String> nodeNames, List<String> logNames, 
    		int severity, String startTimeStr, String endTimeStr, String msgRegex) {
