...
/**
 * Block snapshot session implementation for volumes on Scale IO systems.
 */
public class ScaleIOBlockSnapshotSessionApiImpl extends DefaultBlockSnapshotSessionApiImpl {
    /**
     * Private default constructor should not be called outside class.
     */
    @SuppressWarnings("unused")
    private ScaleIOBlockSnapshotSessionApiImpl() {
        super();
    }
     ...
     */
    public ScaleIOBlockSnapshotSessionApiImpl(DbClient dbClient, CoordinatorClient coordinator, PermissionsHelper permissionsHelper,
