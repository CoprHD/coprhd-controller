 ...
 *         &lt;element name="snapshotVvolId" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "revertVirtualVolume")
public class RevertVirtualVolume {

    @XmlElement(required = true)
    protected String vvolId;
    @XmlElement(required = true)
    protected String snapshotVvolId;
    ...
    /**
     * Gets the value of the snapshotVvolId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSnapshotVvolId() {
        return snapshotVvolId;
    }

    /**
     * Sets the value of the snapshotVvolId property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSnapshotVvolId(String value) {
        this.snapshotVvolId = value;
    }
