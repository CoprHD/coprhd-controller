...
public class RemoteReplicationEstablishCompleter extends TaskCompleter {

    private static final Logger _logger = LoggerFactory.getLogger(RemoteReplicationEstablishCompleter.class);
