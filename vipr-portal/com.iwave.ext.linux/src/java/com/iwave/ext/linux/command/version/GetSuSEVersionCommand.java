...
public class GetSuSEVersionCommand extends LinuxVersionCommand {
    private static final String PACKAGE_NOT_INSTALLED = "package sles-release is not installed";

    public GetSuSEVersionCommand() {
        setCommand("rpm -q --queryformat '%{VERSION}' sles-release");
    }
