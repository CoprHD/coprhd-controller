...
public class VolumeManager extends DefaultManager {
     ...
     * @param arrayId
     */
    public VolumeManager(Registry driverRegistry, LockManager lockManager, String arrayId) {
    ...
    public DriverTask createVolumes(List<StorageVolume> volumes, StorageCapabilities capabilities) {
        ...
        this.managerFactory.genStorageGroupEngine().createEmptySg(null);
        this.managerFactory.genStorageGroupEngine().createNewVolInSg(null, null);
        return task;
    }
}
