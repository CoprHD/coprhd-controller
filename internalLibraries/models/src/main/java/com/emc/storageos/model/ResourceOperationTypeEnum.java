...
public enum ResourceOperationTypeEnum {
    ...
    /* name description */
    CREATE_ARCHIVAL_POLICY("CREATE ARCHIVAL POLICY", "create archival policy operation"),
    CREATE_BACKUP_POLICY("CREATE BACKUP POLICY", "create backup policy operation"),
