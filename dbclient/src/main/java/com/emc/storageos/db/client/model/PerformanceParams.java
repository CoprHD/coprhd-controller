...
public class PerformanceParams extends DataObjectWithACLs implements GeoVisibleResource {
    ...
    public Boolean getCompressionEnabled() {
        return _compressionEnabled == null ? false : _compressionEnabled;
    }
    ...
    public void setHostIOLimitBandwidth(final Integer limitHostBandwidth) {
        _hostIOLimitBandwidth = limitHostBandwidth == null ? null : Math.max(0, limitHostBandwidth);
    ...
    public void setHostIOLimitIOPs(final Integer limitHostIOPs) {
        _hostIOLimitIOPs = limitHostIOPs == null ? null : Math.max(0, limitHostIOPs);
    ...
    public Boolean getDedupCapable() {
        if (null == _dedupCapable) {
            return false;
        }
        return _dedupCapable;
    }
