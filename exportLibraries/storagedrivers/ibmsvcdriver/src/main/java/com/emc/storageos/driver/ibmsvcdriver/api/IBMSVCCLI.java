...
public class IBMSVCCLI {
    ...
    public static IBMSVCQueryIOGrpResult queryAllIOGrps(SSHConnection connection) {
        _log.info("Starting queryAllHost() for Querying IBM-SVC All IOGroup information...");
        IBMSVCQueryIOGrpCommand command = new IBMSVCQueryIOGrpCommand();
        executeCommand(connection, command);
        _log.info("Ending queryAllHost() for Querying IBM-SVC All IOGroup information.");
        return command.getResults();
    }
    ...
    public static IBMSVCQueryHostIOGrpResult queryHostIOGrps(SSHConnection connection, String hostId) {
        _log.info("Starting queryHostIOGrps() for Querying IBM-SVC Host IOGroup information...");
        IBMSVCQueryHostIOGrpCommand command = new IBMSVCQueryHostIOGrpCommand(hostId);
        executeCommand(connection, command);
        _log.info("Ending queryHostIOGrps() for Querying IBM-SVC Host IOGroup information.");
        return command.getResults();
    }
    ...
    public static IBMSVCCreateHostResult createHost(SSHConnection connection, String hostName, String hbawwpns, String ioGrp){
        ...
        executeCommand(connection, command);
        _log.info("Ending createHost() for Creating IBM-SVC Host.");
        return command.getResults();
    }

    public static IBMSVCAddVdiskAccessResult addVdiskAccess(SSHConnection connection, String vdiskID, String ioGrp){
        _log.info("Starting addVdiskAccess() for adding Vdisk access to host ...");
        IBMSVCAddVdiskAccessCommand command = new IBMSVCAddVdiskAccessCommand(ioGrp, vdiskID);
        executeCommand(connection, command);
        _log.info("Ending addVdiskAccess() for adding Vdisk access to host ...");
        return command.getResults();
    }
