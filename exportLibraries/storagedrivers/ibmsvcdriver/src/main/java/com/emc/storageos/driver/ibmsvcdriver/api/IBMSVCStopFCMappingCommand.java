...
public class IBMSVCStopFCMappingCommand extends AbstractIBMSVCQueryCommand<IBMSVCStopFCMappingResult> {

    private final static ParsePattern[] PARSING_CONFIG = new ParsePattern[]{
    };

    public IBMSVCStopFCMappingCommand(String fc_map_Id) {
        addArgument("svctask stopfcmap");
        addArgument(String.format("-force %s", fc_map_Id));
        results = new IBMSVCStopFCMappingResult();
