...
cp /aio-simulators/binaries/*.zip .
ls -ltra *.zip
...
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/cisco-sim/*.zip cisco-sim.zip || exit 1
unzip cisco-sim.zip
...
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/smis-sim/*.zip smis-simulator.zip || exit 1
...
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/hds-sim/*.zip  hds-sim.zip || exit 1
...
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/ldap-sim/*.zip  ldap-sim.zip || exit 1
...
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/rp-sim/*.zip . || exit 1
...
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/win-sim/*.zip  win-sim.zip || exit 1
...
# echo "Downloading $LATEST_URL"
# wget $LATEST_URL || exit 1
#sshpass -p 'dangerous' scp -o 'StrictHostKeychecking=no' root@10.247.98.129:/var/www/simulators/latest/vmware-sim/*.zip  . || exit 1
