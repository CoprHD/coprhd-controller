...
public class XtremIOExportOperations extends XtremIOOperations implements ExportMaskOperations {
    ...
    public void removeInitiator(StorageSystem storage, URI exportMaskURI,
        ...
        try {
            ...
            client = XtremIOProvUtils.getXtremIOClientForSystem(xtremioV1RestClientFactory, xtremioV2RestClientFactory, storage);
    ...
    public ExportMask refreshExportMask(StorageSystem storage, ExportMask mask) {
        try {
            ...
            XtremIOClient client = XtremIOProvUtils.getXtremIOClientForSystem(xtremioV1RestClientFactory, xtremioV2RestClientFactory, storage);
            String xioClusterName = client.getClusterDetails(storage.getSerialNumber()).getName();
