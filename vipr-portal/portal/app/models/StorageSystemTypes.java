...
public class StorageSystemTypes {
	...
	public static final String[] BLOCK_TYPES = { VMAX, VNX_BLOCK, VPLEX, HITACHI, OPENSTACK, SCALEIO, SCALEIOAPI,
			XTREMIO, VNXe, IBMXIV };
	public static final String[] FILE_TYPES = { ISILON, VNX_FILE, NETAPP, DATA_DOMAIN, VNXe, NETAPPC };
	public static final String[] STORAGE_PROVIDER_TYPES = { VMAX, VNX_BLOCK, HITACHI, VPLEX, OPENSTACK, SCALEIO,
			SCALEIOAPI, DATA_DOMAIN, IBMXIV, XTREMIO };
	...
	// new StringOption(SCALEIOAPI,
	// getDisplayValue(STORAGE_PROVIDER_SCALEIOAPI)),
	// new StringOption(DATA_DOMAIN,
	// getDisplayValue(STORAGE_PROVIDER_DATA_DOMAIN)),
	...
	// public static final StringOption[] SMIS_OPTIONS =
	// StringOption.options(STORAGE_PROVIDER_TYPES, OPTION_PREFIX);
	// public static final StringOption[] NON_SMIS_OPTIONS =
	// StringOption.options(NON_SMIS_TYPES, OPTION_PREFIX);
	// public static final StringOption[] SSL_DEFAULT_OPTIONS =
	// StringOption.options(new String[] { VNX_BLOCK, VMAX, SCALEIOAPI, VPLEX,
	// VNX_FILE, VNXe,
	// IBMXIV }, OPTION_PREFIX);
	// public static final StringOption[] NON_SSL_OPTIONS =
	// StringOption.options(new String[] { SCALEIO, XTREMIO });
	// public static final StringOption[] MDM_DEFAULT_OPTIONS =
	// StringOption.options(new String[] { SCALEIO, SCALEIOAPI });
	// public static final StringOption[] MDM_ONLY_OPTIONS =
	// StringOption.options(new String[] {SCALEIOAPI});
	// public static final StringOption[] ELEMENT_MANAGER_OPTIONS =
	// StringOption.options(new String[] { SCALEIO });
