 ...
 *
 */
public class RefreshApplicationMigration extends WaitForTasks<TaskResourceRep> {
     ...
     */
    public RefreshApplicationMigration(URI mobilityGroupId) {
        super();
    ...
    protected Tasks<TaskResourceRep> doExecute() throws Exception {
        TaskList taskList = getClient().application().refreshMigration(mobilityGroupId);
