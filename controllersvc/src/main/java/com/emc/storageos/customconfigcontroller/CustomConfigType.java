...
public class CustomConfigType implements Serializable {
	 ...
	 * configuration. This property applies only to configurations of type
	 * {@link ConfigType#CustomName}. The boolean value indicates in this source
	 ...
	 * provided.
	 * <p>
	 * This default value is used when a user-defined customized value is not
	 * found for a given scope.
	 * 
