...
public class ServiceCatalog extends Controller {
    ...
    public static void docCategory(String categoryId) {
        ...
        Logger.debug("Redirecting to doc page for category: " + category.getName()); //NOSONAR ("Suppressing Sonar violation of Possible null pointer deference of category. In the previous if condition, category being null is handled. category cannot be null here.")
