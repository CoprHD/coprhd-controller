...
public class UcsComputeDevice implements ComputeDevice {
        ...
        try {
            ...
            createSpToken = workflow.createStep(CREATE_SP_FROM_SPT_STEP,
                    ...
                    computeSystem.getId(), computeSystem.getSystemType(), this.getClass(), new Workflow.Method(
                            "createLsServerStep", computeSystem, sptDn, host),
                    new Workflow.Method(
                            "deleteLsServerStep", computeSystem, host.getId(), createSpToken),
                    createSpToken);
            ...
            modifySpBootToken = workflow
                    .createStep(
                            ...
                            new Workflow.Method("deleteLsServerStep", computeSystem, host.getId(), createSpToken), modifySpBootToken);
     ...
     */
    public boolean createLsServerStep(ComputeSystem cs, String sptDn, Host host, String stepId) {
     ...
     * @return LsServer instance
     */
    public LsServer modifyLsServerNoBootStep(ComputeSystem cs, String contextStepId, String stepId) {
