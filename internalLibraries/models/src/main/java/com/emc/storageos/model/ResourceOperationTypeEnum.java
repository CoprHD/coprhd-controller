...
public enum ResourceOperationTypeEnum {
    ...
    MIGRATION_CREATE("MIGRATION CREATE", "create migration"),
    MIGRATION_MIGRATE("MIGRATION MIGRATE", "migrate"),
    ...
    MIGRATION_SYNCSTOP("MIGRATION SYNCSTOP", "refresh migration status"),
    MIGRATION_SYNCSTART("MIGRATION SYNCSTART", "synchronize source volumes in a migration"),
