...
/**
 * Responsible for unmounting file systems on the VNX.
 */
public class VNXFileSystemUnmountProcessor extends VNXFileProcessor {

    private final Logger _logger = LoggerFactory.getLogger(VNXFileSystemUnmountProcessor.class);
