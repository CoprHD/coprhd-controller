...
;   private static final String DELETE_MIGRATION_SOURCES_SUSPEND_MESSAGE = 
     ...
     * @return method
     */
    private Workflow.Method storageViewAddVolumesMethod(URI vplexURI, URI exportGroupURI, URI exportMaskURI, Map<URI, Integer> volumeMap) {
    ...
    public void storageViewAddVolumes(URI vplexURI, URI exportGroupURI, URI exportMaskURI,
        ...
        try {
            ...
            // commented it for now, because i am no expert in this area and a discussion with the experts would make sense).
            ...
            // objects, but there is no step or workflow created for this call and passed in.
            // From my observation this call was inadvertently setting the workflow completer to success that operations
            // waiting on this would kick off prior to actually adding the volumes
            // to the storage view. In case of RP, the createCg call would fire off and fail because it would execute
            // before all the volumes made it to the storageview on the VPLEX.
            ...
            ExportOperationContext.insertContextOperation(completer, VPlexExportOperationContext.OPERATION_ADD_VOLUMES_TO_STORAGE_VIEW,
                    new ArrayList<URI>(volumesToAdd.keySet()));
     ...
     * @return method
     */
    private Workflow.Method storageViewAddVolumesRollbackMethod(URI vplexURI, URI exportGroupURI, URI exportMaskURI, List<URI> volumeURIs,
            String contextKey) {
        return new Workflow.Method("storageViewAddVolumesRollback", vplexURI, exportGroupURI, exportMaskURI, volumeURIs, contextKey);
    }
    ...
    public void storageViewAddVolumesRollback(URI storageURI, URI exportGroupURI,
        ...
        try {
            ...
            storageViewRemoveVolumes(storageURI, mask, volumeURIs, taskCompleter, token);
        } catch (Exception e) {
    ...
    public Workflow.Method storageViewRemoveVolumesMethod(URI vplexURI, ExportMask exportMask, List<URI> volumeURIList,
        ...
        return new Workflow.Method("storageViewRemoveVolumes", vplexURI, exportMask, volumeURIList, taskCompleter);
    }
     ...
     * @throws WorkflowException
     */
    public void storageViewRemoveVolumes(URI vplexURI, ExportMask exportMask, List<URI> volumeURIList, TaskCompleter taskCompleter,
     ...
     * @throws Exception
     */
    private void removeVolumesFromStorageViewAndMask(VPlexApiClient client, ExportMask exportMask, List<URI> volumeURIList, String stepId)
            throws Exception {
    ...
    private String addStepsForAddInitiators(Workflow workflow, StorageSystem vplex,
        ...
        if (exportMask == null) {
            ...
            zoningStepId = workflow.createStep(ZONING_STEP, String.format("Zone initiator %s to ExportGroup %s(%s)",
                    initListStr, exportGroup.getLabel(), exportURI), previousStepId, vplexURI, vplex.getSystemType(),
            ...
            Workflow.Method addToViewRollbackMethod = storageViewAddInitiatorsRollbackMethod(vplexURI, exportURI, exportMask.getId(),
                    StringSetUtil.stringSetToUriList(exportMask.getVolumes().keySet()), hostInitiatorURIs, addInitStepId);
            lastStepId = workflow.createStep("storageView", "Add " + message, zoningStepId, vplexURI, vplex.getSystemType(),
                    this.getClass(), addToViewMethod, addToViewRollbackMethod, addInitStepId);
        }
        return lastStepId;
    }
                ...
                if (!initiatorPortInfos.isEmpty()) {
                    ...
                    try {
                        ...
                        ExportOperationContext.insertContextOperation(taskCompleter,
                                VPlexExportOperationContext.OPERATION_ADD_INITIATORS_TO_STORAGE_VIEW, initiatorURIs);
                    } finally {
                        if (lockAcquired) {
                            _vplexApiLockManager.releaseLock(lockName);
                        }
    ...
    public void storageViewAddInitiatorsRollback(URI storageURI, URI exportGroupURI,
        ...
        storageViewRemoveInitiators(storageURI, exportGroupURI, exportMaskURI, volumeURIs, initiatorURIs, taskCompleter, token);
    }
    ...
    public void exportGroupRemoveInitiators(URI vplexURI, URI exportURI,
            List<URI> initiatorURIs, String opId) throws ControllerException {
        try {
            StorageSystem vplex = getDataObject(StorageSystem.class, vplexURI, _dbClient);
            ExportGroup exportGroup = getDataObject(ExportGroup.class, exportURI, _dbClient);
            ...
            for (URI hostURI : hostInitiatorsMap.keySet()) {
                ...
                for (ExportMask exportMask : exportMasks) {
                    ...
                    lastStep = addStepsForRemoveInitiators(vplex, workflow, exportGroup, exportMask, initsToRemove,
