...
class Cluster(object):
    ...
    def cluster_create(self, label, tenant, datacenter,
                            vcenter, autoexportsenabled):
    ...
    def cluster_update(self, name, tenant, datacenter, vcenter,
                                     label, autoexportsenabled):
        '''
