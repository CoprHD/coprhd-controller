...
public abstract class Processor {
    ...
    protected String createKeyfromPath(CIMObjectPath sourcePath) {
        String systemName = sourcePath.getKey(SystemNamestr).getValue().toString().replaceAll(Constants.SMIS80_DELIMITER_REGEX, Constants.PLUS);
   ...
   protected boolean isIBMInstance(CIMInstance instance) {
       return Constants.IBM_NAMESPACE.equals(instance.getObjectPath().getNamespace()) || instance.getClassName().startsWith(Constants.IBMXIV_CLASS_PREFIX);
   }
