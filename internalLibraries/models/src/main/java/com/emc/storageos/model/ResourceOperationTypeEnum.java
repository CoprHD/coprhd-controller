...
public enum ResourceOperationTypeEnum {
    ...
    CREATE_VOLUME_GROUP_FULL_COPY("CREATE APPLICATION FULL COPY", "create a application full copy"),
    ACTIVATE_VOLUME_GROUP_FULL_COPY("ACTIVATE APPLICATION FULL COPY", "activate a application full copy"),
    DETACH_VOLUME_GROUP_FULL_COPY("DETACH APPLICATION FULL COPY", "detach a application full copy"),
    RESTORE_VOLUME_GROUP_FULL_COPY("RESTORE APPLICATION FULL COPY", "restore a application full copy"),
    RESYNCHRONIZE_VOLUME_GROUP_FULL_COPY("RESYNCHRONIZE APPLICATION FULL COPY", "resynchronize a application full copy"),
