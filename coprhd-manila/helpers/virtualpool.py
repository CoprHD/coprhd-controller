...
class VirtualPool(object):
    ...
    def vpool_list_by_hrefs(self, hrefs):
        res = commoncoprhdapi.list_by_hrefs(self.__ipAddr, self.__port, hrefs)
        return res
    ...
    def vpool_get_tenant(self, vpooltype, vpooluri):
        ...
        o = commoncoprhdapi.json_decode(s)
        tenantids = []
        acls = commoncoprhdapi.get_node_value(o, "acl")
        for acl in acls:
    ...
    def vpool_getpools(self, name, vpooltype):
        ...
        o = commoncoprhdapi.json_decode(s)
        output = commoncoprhdapi.list_by_hrefs(self.__ipAddr, self.__port,
                                      commoncoprhdapi.get_node_value(o, "storage_pool"))
        return output
...
def vpool_create(args):
    try:
        ...
        if (e.err_code == SOSError.VALUE_ERR):
            ...
            commoncoprhdapi.format_err_msg_and_raise("create", "vpool", e.err_text,
                                            e.err_code)
...
def vpool_update(args):
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("update", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_delete(args):
    ...
    try:
        ...
        if (e.err_code == SOSError.SOS_FAILURE_ERR):
            ...
            commoncoprhdapi.format_err_msg_and_raise("delete", "vpool", e.err_text,
                                            e.err_code)
...
def vpool_show(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("show", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_getpools(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("get_pools", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_refreshpools(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("refresh_pools", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_addpools(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("add_pools", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_removepools(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("remove_pools", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_allow_tenant(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("allow", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_remove_tenant(args):
    ...
    try:
        ...
        commoncoprhdapi.format_err_msg_and_raise("disallow", "vpool", e.err_text,
                                        e.err_code)
...
def vpool_list(args):
    ...
    try:
        ...
        if (e.err_code == SOSError.SOS_FAILURE_ERR):
            ...
            commoncoprhdapi.format_err_msg_and_raise("list", "vpool", e.err_text,
                                            e.err_code)
