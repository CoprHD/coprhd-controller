...
/**
 * Block snapshot session implementation for volumes on VNXE systems.
 */
public class VNXEBlockSnapshotSessionApiImpl extends DefaultBlockSnapshotSessionApiImpl {
    /**
     * Private default constructor should not be called outside class.
     */
    @SuppressWarnings("unused")
    private VNXEBlockSnapshotSessionApiImpl() {
        super();
    }
     ...
     */
    public VNXEBlockSnapshotSessionApiImpl(DbClient dbClient, CoordinatorClient coordinator, PermissionsHelper permissionsHelper,
