 ...
 *         &lt;element name="capabilityProfileId" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "spaceStatsForStorageContainer")
public class SpaceStatsForStorageContainer {

    @XmlElement(required = true)
    protected String containerId;
    protected List<String> capabilityProfileId;
     ...
     * 
     */
    public List<String> getCapabilityProfileId() {
        if (capabilityProfileId == null) {
            capabilityProfileId = new ArrayList<String>();
        }
