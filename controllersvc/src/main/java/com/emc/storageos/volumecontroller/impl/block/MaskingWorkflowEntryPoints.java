...
public class MaskingWorkflowEntryPoints implements Controller {
    ...
    /**
     * Rollback entry point. This is a wrapper around the doExportMaskRemovePaths
     * operation, which requires that we create a specific completer using the token
     * that's passed in. This token is generated by the rollback processing.
     *
     ...
     * @param contextKey - context token
     * @param token - String token generated by the rollback processing
     * @throws ControllerException
     */
    public void rollbackExportGroupAddPaths(URI storageURI, URI exportGroupURI,
            URI exportMaskURI, Map<URI, List<URI>> paths,
            String contextKey, String token) throws ControllerException {
        ...
        doExportMaskRemovePaths(storageURI, exportGroupURI, exportMaskURI, paths, taskCompleter, token);
    }
    
    /**
     * Rollback entry point. This is a wrapper around the doExportMaskAddPaths
     * operation, which requires that we create a specific completer using the token
     * that's passed in. This token is generated by the rollback processing.
     *
     * @param storageURI - StorageSystem URI
     ...
     * @throws ControllerException
     */
    public void rollbackExportGroupRemovePaths(URI storageURI, URI exportGroupURI,
            URI exportMaskURI, Map<URI, List<URI>> paths,
            String contextKey, String token) throws ControllerException {
        ExportTaskCompleter taskCompleter = new ExportOrchestrationTask(exportGroupURI, token);
        // Take the context of the step in flight and feed it into our current step
        ...
        doExportMaskAddPaths(storageURI, exportGroupURI, exportMaskURI, paths, taskCompleter, token);
    }
}
