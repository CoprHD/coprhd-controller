...
/**
 * Update parameter for Virtual Machine
 */
public class VirtualMachinesUpdateParam extends UpdateParam {

    public VirtualMachinesUpdateParam() {
    }

    public VirtualMachinesUpdateParam(Set<URI> add, Set<URI> remove) {
        this.add = add;
        this.remove = remove;
    }
