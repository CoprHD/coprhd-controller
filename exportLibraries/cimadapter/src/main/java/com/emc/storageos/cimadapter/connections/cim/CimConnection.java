...
public class CimConnection {
	 ...
	 *            The bean containing the connection information.
	 * @param listener
	 *            The CIM indication listener for this connection.
	 * @param filterMap
	 *            The indication filters to be subscribed for this connection.
	 */
	public CimConnection(CimConnectionInfo connectionInfo, CimListener listener, CimFilterMap filterMap)
			throws Exception {
	 ...
	 * 
	 * @param subscriptionsIdentifier
	 *            The identifier to be used to identify subscriptions on the
	 *            provider.
	 * @param deleteStaleSubscriptions
	 *            true to delete stale subscriptions on the provider to which
	 *            the connection is being made.
	 * 
	 * @throws Exception
	 *             if the connection cannot be established or if there is a
	 *             problem setting up subscriptions.
	 */
	public void connect(String subscriptionsIdentifier, boolean deleteStaleSubscriptions) throws Exception {
		...
		CIMObjectPath path = CimObjectPathCreator.createInstance(protocol, _host, Integer.toString(_port), _interopNS,
				null, null);
		try {
	...
	/**
	 * Make new subscription to active SMIS provider to get indications for
	 * monitoring
	 * 
	 * @param subscriptionsIdentifier
	 *            {@link String} subscriptionIdentifer to make subscription
	 * @throws Exception
	 */
	public void subscribeForIndications(String subscriptionsIdentifier) throws Exception {
		...
		try {
			// Register the connection with the listener if indications are
			// enabled
			// for the connection.
			if ((_listener != null)) {
	 ...
	 * 
	 * @param subscriptionsIdentifier
	 *            {@link String} subscriptionIdentifer to make Un-Subscription
	 */
	 ...
	 * 
	 * @param subscriptionsIdentifier
	 *            {@link String} subscriptionIdentifer to delete stale
	 *            subscriptions
	 */
	...
	public boolean isConnected() {
		...
		try {
			...
			// connection is up.
			_cimClient.getClass(
					CimObjectPathCreator.createInstance(CimConstants.CIM_INDICATION_OBJ_PATH, getInteropNamespace()),
