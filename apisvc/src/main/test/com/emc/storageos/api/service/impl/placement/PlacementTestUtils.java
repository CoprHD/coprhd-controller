...
public class PlacementTestUtils {
	...
	public static StoragePort createStoragePort(DbClient _dbClient, DiscoveredSystemObject storageSystem, Network network, String portNetworkId, VirtualArray varray, String portType, String portGroup, String portName) {
	...
	public static List invokePlacement(DbClient dbClient, CoordinatorClient _coordinator, VirtualArray varray, Project project, VirtualPool vpool,
