...
/**
 * Responsible for Mounting file systems on the VNX.
 */
public class VNXFileSystemMountProcessor extends VNXFileProcessor {

    private final Logger _logger = LoggerFactory.getLogger(VNXFileSystemMountProcessor.class);
