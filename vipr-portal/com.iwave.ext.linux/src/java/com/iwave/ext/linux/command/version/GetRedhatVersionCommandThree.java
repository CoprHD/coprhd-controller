...
public class GetRedhatVersionCommandThree extends LinuxVersionCommand {
    private static final String PACKAGE_NOT_INSTALLED = "package redhat-release-server is not installed";

    public GetRedhatVersionCommandThree() {
        setCommand("rpm -q --queryformat '%{VERSION}' redhat-release-server");
    }
