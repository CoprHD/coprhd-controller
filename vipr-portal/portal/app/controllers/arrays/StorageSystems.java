...
public class StorageSystems extends ViprResourceController {
    ...
    public static void addTagsToPorts(@As(",") String[] ids, String arrayId, StoragePortTags storagePortTags) {
        Set<String> addTags = new HashSet<String>();
        addTags.add(storagePortTags.getCustomTag());
        BourneUtil.getViprClient().storagePorts().addTags(uri(ids[0]), addTags);
        ports(arrayId);
    }
    ...
    public static void metricDetails(String id) {
        StoragePortRestRep portRep = StoragePortUtils.getStoragePort(id);
        StoragePortMoreDetails port = new StoragePortMoreDetails();
        Set<String> tags = BourneUtil.getViprClient().storagePorts().getTags(uri(id));
        BeanUtils.copyProperties(portRep, port);
        port.setPortTags(StringUtils.join(tags, ", "));
        render(port);
    }
    ...
    public static class StoragePortTags {
        ...
        public void setPredefinedTags(List<String> predefinedTags) {
    ...
    public static class StoragePortMoreDetails extends StoragePortRestRep {
        ...
        public void setPortTags(String portTags) {
