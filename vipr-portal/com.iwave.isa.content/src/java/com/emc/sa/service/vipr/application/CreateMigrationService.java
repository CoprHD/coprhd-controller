...
import com.emc.sa.service.vipr.application.tasks.CreateApplicationMigration;
...
public class CreateMigrationService extends ViPRService {
    ...
    public void execute() throws Exception {
        Tasks<? extends DataObjectRestRep> tasks = execute(new CreateApplicationMigration(mobilityGroupId, targetVarray, targetVpool));
