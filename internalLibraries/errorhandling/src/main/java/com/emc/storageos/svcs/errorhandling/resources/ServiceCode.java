...
public enum ServiceCode {
    ...
    SYS_DR_RESUME_STANDBY_FAILED(30051),
    SYS_DR_RESUME_STANDBY_TIMEOUT(30052),
    SYS_DR_DATA_SYNC_TIMEOUT(30053),
    SYS_DR_SWITCHOVER_PRECHECK_FAILED(30054),
    SYS_DR_SWITCHOVER_FAILED(30055),
    SYS_DR_SWITCHOVER_PRIMARY_FAILED_TIMEOUT(30056),
    SYS_DR_SWITCHOVER_STANDBY_FAILED_TIMEOUT(30057),
    SYS_DR_FAILOVER_FAILED(30058),
    SYS_DR_FAILOVER_PRECHECK_FAILED(30059),
    SYS_DR_FAILOVER_RECONFIG_FAIL(30060),

    SYS_INTERNAL_SERVICE_NAME_NOT_FOUND(30061),
