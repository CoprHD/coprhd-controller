...
public class CreateFileSystem extends WaitForTask<FileShareRestRep> {
	...
	public CreateFileSystem(String label, double sizeInGB, int advisoryLimit, int softLimit, int gracePeriod,
			URI vpoolId, URI varrayId, URI projectId, String owner) {
        this.label = label;
		...
		this.owner = owner;
		provideDetailArgs(label, sizeInGB, advisoryLimit, softLimit, gracePeriod, vpoolId, varrayId, projectId, owner);
    }
