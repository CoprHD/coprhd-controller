...
public enum ServiceCode {
    ...
    SYS_DR_REMOVE_STANDBY_RECONFIG_FAIL(30048),
    SYS_DR_PAUSE_STANDBY_FAILED(30049),
    SYS_DR_RESUME_STANDBY_FAILED(30050),
    SYS_DR_RESUME_STANDBY_TIMEOUT(30051),
    SYS_DR_DATA_SYNC_TIMEOUT(30052),
    SYS_DR_SWITCHOVER_PRECHECK_FAILED(30053),
    SYS_DR_SWITCHOVER_FAILED(30054),
    SYS_DR_SWITCHOVER_PRIMARY_FAILED_TIMEOUT(30055),
    SYS_DR_SWITCHOVER_STANDBY_FAILED_TIMEOUT(30056),
    SYS_DR_ACQUIRE_OPERATION_LOCK_FAILED(30057),
    SYS_DR_CONCURRENT_OPERATION_NOT_ALLOWED(30058),
    SYS_DR_FAILOVER_FAILED(30059),
    SYS_DR_FAILOVER_PRECHECK_FAILED(30060),
    SYS_DR_FAILOVER_RECONFIG_FAIL(30061),
    SYS_INTERNAL_SERVICE_NAME_NOT_FOUND(30062),
    SYS_DR_CREATE_VIPR_CLIENT_FAILED(30063),
