...
public class InvalidRepositoryInfoException extends FatalCoordinatorException {
    ...
    protected InvalidRepositoryInfoException(final ServiceCode code, final Throwable cause, final String detailBase, final String detailKey, final Object[] detailParams) {
