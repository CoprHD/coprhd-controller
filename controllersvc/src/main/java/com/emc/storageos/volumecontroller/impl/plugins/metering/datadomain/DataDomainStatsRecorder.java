    ...
    public Stat addUsageInfo(DDStatsCapacityInfo statsCapInfo, Map<String, Object> keyMap, 
    	...
    	if (stat != null) {
            try {
                ...
                switch(granularity) {
                case hour: measurementTimePeriodInSec = HOUR_IN_SECONDS;
                           break;
                case day:  measurementTimePeriodInSec = DAY_IN_SECONDS;
                           break;
                case week: measurementTimePeriodInSec = WEEK_IN_SECONDS;
                           break;
                }
