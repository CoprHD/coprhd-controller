...
public class RemoteReplicationSwapCompleter extends TaskCompleter {

    private static final Logger _logger = LoggerFactory.getLogger(RemoteReplicationSwapCompleter.class);
    ...
    public RemoteReplicationSwapCompleter(RemoteReplicationElement remoteReplicationElement, String opId) {
