 ...
 *         &lt;element name="baseVvolId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "unsharedChunksVirtualVolume")
public class UnsharedChunksVirtualVolume {

    @XmlElement(required = true)
    protected String vvolId;
    @XmlElementRef(name = "baseVvolId", namespace = "http://com.vmware.vim.vasa/2.0/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> baseVvolId;
     ...
     *     
     */
    public JAXBElement<String> getBaseVvolId() {
        return baseVvolId;
    }
     ...
     *     
     */
    public void setBaseVvolId(JAXBElement<String> value) {
