...
public enum ResourceOperationTypeEnum {
    ...
    UPDATE_EXTERNAL_DELETED_DATASTORE("UPDATE EXTERNAL DELETED DATASTORE", "update externally deleted data store operation"),
    UPDATE_EXTERNAL_CREATED_DATASTORE("UPDATE EXTERNAL CREATED DATASTORE", "update externally created data store operation"),
