...
public class CommonTransformerFunctions {
	...
	public static final Function<BlockMirror, URI> FCTN_MIRROR_TO_URI = new Function<BlockMirror, URI>() {
		@Override
	...
	public static final Function<DataObject, String> FCTN_VOLUME_URI_TO_STR = new Function<DataObject, String>() {
		@Override
	...
	public static final Function<String, URI> FCTN_STRING_TO_URI = new Function<String, URI>() {
		@Override
	...
	public static final Function<String, Integer> FCTN_STRING_TO_INTEGER = new Function<String, Integer>() {
		@Override
	...
	public static final Function<URI, String> FCTN_URI_TO_STRING = new Function<URI, String>() {
		@Override
	...
	public static Function<String, Initiator> fctnStringToInitiator(final DbClient dbClient) {
		return new Function<String, Initiator>() {
			@Override
			public Initiator apply(String uriStr) {
				Initiator initiator = null;
				if (uriStr != null && !uriStr.isEmpty()) {
					initiator = dbClient.queryObject(Initiator.class, URI.create(uriStr));
				}
				return initiator;
			}
		};
	...
	public static Function<String, Host> fctnStringToHost(final DbClient dbClient) {
		return new Function<String, Host>() {
			@Override
			public Host apply(String uriStr) {
				Host host = null;
				if (uriStr != null && !uriStr.isEmpty()) {
					host = dbClient.queryObject(Host.class, URI.create(uriStr));
				}
				return host;
			}
		};
	...
	public static Function<Initiator, String> fctnInitiatorToPortName() {
	...
	public static Function<DataObject, URI> fctnDataObjectToID() {
	...
	public static Function<BlockObject, String> fctnBlockObjectToNativeID() {
	...
	public static Function<BlockObject, String> fctnBlockObjectToLabel() {
		return new Function<BlockObject, String>() {
			@Override
			public String apply(BlockObject blockObject) {
	...
	public static Function<BlockObject, String> fctnBlockObjectToNativeGuid() {
		return new Function<BlockObject, String>() {
	...
	public static Function<StoragePort, String> fctnStoragePortToPortName() {
	...
	public static Function<StoragePort, String> fctnStoragePortToNetworkId() {
		return new Function<StoragePort, String>() {
	...
	public static final Function<VplexMirror, URI> FCTN_VPLEX_MIRROR_TO_URI = new Function<VplexMirror, URI>() {
		@Override
	...
	public static String collectionToString(Collection collection) {
		...
		if (collection != null) {
			...
			if (isTruncatedList) {
				collectionAsString = collectionAsString.concat(
