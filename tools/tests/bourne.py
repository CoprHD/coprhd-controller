...
URI_REMOTEREPLICATIONSET_RESTORE          = URI_SERVICES_BASE   + '/vdc/block/remotereplicationsets/{0}/restore'
...
URI_REMOTEREPLICATIONGROUP_RESTORE        = URI_SERVICES_BASE   + '/vdc/block/remotereplicationgroups/{0}/restore'
