...
public interface ComputeSystemControllerExceptions {
	...
	@DeclareServiceCode(ServiceCode.CONTROLLER_COMPUTESYSTEM_ERROR)
	public ComputeSystemControllerTimeoutException timeoutWaitingForMOTerminalState(final String moDn,final String currentState,final int timeOutIntervalInMS);
