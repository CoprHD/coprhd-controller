...
//public class CustomSample extends ExecutionTask<Object> {
	...
	public void init() throws Exception {
		System.out.println("External Custom Task init");
		
	}
	@Override
	public void precheck() throws Exception {
		System.out.println("External Custom Task precheck");
	...
	public TaskInfo executeExternal(String extenalTaskParam) throws Exception {
		System.out.println("External Custom Task executeExternal "+extenalTaskParam);
	...
	public void postcheck() throws Exception {
		System.out.println("External Custom Task postcheck");
		
	}
	@Override
	public void postLaunch(String extenalTaskParam) throws Exception {
		System.out.println("External Custom Task postLuanch "+extenalTaskParam);
		
	}
	@Override
	public void getStatus() throws Exception {
		System.out.println("External Custom Task getStatus");
		
	}
	@Override
	public void destroy() {
		System.out.println("External Custom Task destroy");
