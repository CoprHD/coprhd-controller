...
public enum ResourceOperationTypeEnum {
    ...
    ADD_VIRTUAL_MACHINE_INITIATOR("ADD VIRTUAL MACHINE INITIATOR", "add an initiator associated with a virtual machine"),
    ADD_VIRTUAL_MACHINE_PAIRED_INITIATOR("ADD VIRTUAL MACHINE PAIRED INITIATOR",
            "add an paired initiator associated with a virtual machine"),
    ...
    DISCOVER_VIRTUAL_MACHINE("DISCOVER VIRTUAL MACHINE", "discover a compute virtual machine"),
    CREATE_VIRTUAL_MACHINE("CREATE VIRTUAL MACHINE", "create a compute virtual machine"),
    ...
    DELETE_VIRTUAL_MACHINE("DELETE VIRTUAL MACHINE", "delete a compute virtual machine"),
    DELETE_VIRTUAL_MACHINE_IPINTERFACE("DELETE VIRTUAL MACHINE IP INTERFACE", "delete a compute virtual machine's IP interface"),
