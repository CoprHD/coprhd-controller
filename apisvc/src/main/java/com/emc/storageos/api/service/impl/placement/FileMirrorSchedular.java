...
public class FileMirrorSchedular implements Scheduler {
    ...
    public List getRecommendationsForResources(VirtualArray varray,
        ...
        if( vpool.getFileReplicationType().equals(VirtualPool.FileReplicationType.REMOTE.name())){
            recommendations = getLocalRemoteMirrorRecommendationsForResources(varray, project, vpool, capabilities);
     ...
     * @return list of Recommendation objects to satisfy the request
     */
    public List getLocalRemoteMirrorRecommendationsForResources(VirtualArray varray,
            Project project, VirtualPool vpool,
            VirtualPoolCapabilityValuesWrapper capabilities) {
        ...
        Set<RemoteReplicationPoolMapping> setReplicationPoolMappings =  scheduleStorageSourcePoolConstraint(varray, project, vpool, capabilities,
                candidatePools, null);
        
        //prepare the final mirror recommendation for source and target
