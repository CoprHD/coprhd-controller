...
public interface BlockStorageDevice {
	...
	/**
	 * Export one or more volumes for the ExportMask. The volumeToExports
	 * parameter has all the information required to do the add volumes
	 * operation.
	 * 
	 * @param storage
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportCreate(StorageSystem storage, ExportMask exportMask, Map<URI, Integer> volumeMap,
			List<Initiator> initiators, List<URI> targets, TaskCompleter taskCompleter)
			throws DeviceControllerException;

	/**
	 * Delete an export mask and all associated mappings that exists at the
	 * storage systems
	 * 
	 * @param storage
	 * @param exportMask
	 * @param volumeURIs
	 *            volumes that are impacted by this operation
	 * @param initiatorURIs
	 *            initiators that are impacted by this operation
	 * @param taskCompleter
	 * @return
	 * @throws DeviceControllerException
	 */
	public void doExportDelete(StorageSystem storage, ExportMask exportMask, List<URI> volumeURIs,
			List<URI> initiatorURIs, TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportAddVolume(StorageSystem storage, ExportMask exportMask, URI volume, Integer lun,
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportAddVolumes(StorageSystem storage, ExportMask exportMask, List<Initiator> initiators,
			Map<URI, Integer> volumes, TaskCompleter taskCompleter) throws DeviceControllerException;

	/**
	 * Remove one or more volumes for the ExportMask. The volumeToExports
	 * parameter has all the information required to do the remove volumes
	 * operation.
	 * 
	 * @param storage
	 *            URI of storage controller
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportRemoveVolumes(StorageSystem storage, ExportMask exportMask, List<URI> volumes,
			List<Initiator> initiators, TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportAddInitiator(StorageSystem storage, ExportMask exportMask, List<URI> volumeURIs,
			Initiator initiator, List<URI> targets, TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportAddInitiators(StorageSystem storage, ExportMask exportMask, List<URI> volumeURIs,
			List<Initiator> initiators, List<URI> targets, TaskCompleter taskCompleter)
			throws DeviceControllerException;
	 ...
	 *            URI of ExportMask at the storage device
	 * @param volumes
	 *            Volumes that will no longer be visible to the removed
	 *            initiators
	 * @param initiator
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportRemoveInitiator(StorageSystem storage, ExportMask exportMask, List<URI> volumes,
			Initiator initiator, List<URI> targets, TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 * @throws DeviceControllerException
	 */
	public void doExportRemoveInitiators(StorageSystem storage, ExportMask exportMask, List<URI> volumes,
			List<Initiator> initiators, List<URI> targets, TaskCompleter taskCompleter)
			throws DeviceControllerException;
	 ...
	 * @throws DeviceControllerException
	 */
	public void doCreateSingleSnapshot(StorageSystem storage, List<URI> snapshotList, Boolean createInactive,
	...
	/**
	 * Activate a snapshot. Activation means that the source and target
	 * synchronization will be established.
	 * 
	 * @param storage
	 * @param snapshotList
	 * @param taskCompleter
	 ...
	 * @throws DeviceControllerException
	 */
	void doDeleteSelectedSnapshot(StorageSystem storage, URI snapshot, TaskCompleter taskCompleter)
			throws DeviceControllerException;
	 ...
	 * 
	 * @param storage
	 *            Storage system the snapshot created on
	 * @param volume
	 *            The URI of the snapshot's parent volume
	 * @param snapshot
	 *            The URI of the snapshot to be resynchronized
	 * @param taskCompleter
	 *            The task completer
	 * @throws DeviceControllerException
	 */
	...
	/**
	 * Fracture a mirror or mirrors for a volume or volumes. Create group
	 * mirrors for volumes in a CG.
	 * 
	 * @param storage
	 * @param mirrorList
	 * @param createInactive
	 ...
	 * @throws DeviceControllerException
	 */
	public void doDetachGroupMirrors(StorageSystem storage, List<URI> mirrorList, Boolean deleteGroup,
			TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 *            the task completer
	 * @throws DeviceControllerException
	 *             the device controller exception
	 */
	public void doEstablishVolumeFullCopyGroupRelation(StorageSystem storage, URI sourceVolume, URI fullCopy,
			TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 * @param taskCompleter
	 */
	public void doCreateGroupClone(StorageSystem storageSystem, List<URI> cloneVolumes, Boolean createInactive,
			TaskCompleter taskCompleter);
	 ...
	 * @param taskCompleter
	 */
	public void doDeleteConsistencyGroup(StorageSystem storage, URI consistencyGroup, String replicationGroupName,
			Boolean keepRGName, Boolean markInactive, TaskCompleter taskCompleter) throws DeviceControllerException;
	...
	/**
	 * Implementation should attach an inactive CG blocksnapshot set to target
	 * devices.
	 * 
	 * @param storage
	 ...
	 * @param snapshotList
	 * @param taskCompleter
	 *            - TaskCompleter object used for the updating operation
	 *            status. @throws DeviceControllerException
	 */
	 ...
	 *             TODO
	 */
	public Map<String, Set<URI>> findExportMasks(StorageSystem storage, List<String> initiatorNames,
			boolean mustHaveAllPorts) throws DeviceControllerException;

	/**
	 * For the given list of initiators, go to the Storage Array and get the
	 * list of HLUs that the volumes are assigned with.
	 *
	 * @param storage
	 *            the storage system
	 * @param initiatorNames
	 *            the initiator names
	 * @param mustHaveAllPorts
	 *            If true, *all* the passed in initiators have to be in the
	 *            existing matching mask. If false, a mask with *any* of the
	 *            specified initiators will be considered a hit.
	...
	/**
	 * This call will be used to update the ExportMask with the latest data from
	 * the array.
	 * 
	 * @param storage
	 *            [in] - StorageSystem object representing the array
	 ...
	 * @return instance of ExportMask object that has been refreshed with data
	 *         from the array.
	 * @throws DeviceControllerException
	 *             TODO
	 */
	 ...
	 * @param completer
	 */
	public void doActivateGroupFullCopy(StorageSystem storageSystem, List<URI> fullCopy, TaskCompleter completer);
	...
	/**
	 * Poll the synchronization state of a replication relationship. Mark the
	 * task completer as ready when the synchronized state has been reached.
	 * 
	 * @param storageObj
	 * @param target
	 * @param completer
	 */
	public void doWaitForSynchronized(Class<? extends BlockObject> clazz, StorageSystem storageObj, URI target,
			TaskCompleter completer);

	/**
	 * Poll the synchronization state of a group replication relationship. Mark
	 * the task completer as ready when the synchronized state has been reached.
	 * 
	 * @param storageObj
	 * @param target
	 * @param completer
	 ...
	 *            the volume uris
	 * @param newVpool
	 *            the new vPool where policy name and limits settings can be
	 *            obtained
	 * @param rollback
	 *            boolean to know if it is called as a roll back step from
	 *            workflow.
	 * @param taskCompleter
	 *            the task completer
	 * @throws Exception
	 ...
	 *             the device controller exception
	 */
	public void doEstablishVolumeNativeContinuousCopyGroupRelation(StorageSystem storage, URI sourceVolume, URI mirror,
			TaskCompleter taskCompleter) throws DeviceControllerException;
	 ...
	 *             the device controller exception
	 */
	public void doEstablishVolumeSnapshotGroupRelation(StorageSystem storage, URI sourceVolume, URI snapshot,
			TaskCompleter taskCompleter) throws DeviceControllerException;

	/**
	 * For mirrors associated with SRDF volumes, remove the mirrors from device
	 * masking group equivalent to its Replication group.
	 * 
	 * @param system
	 *            the system
	 * @param mirrors
	 ...
	 *            the task completer
	 */
	public void doResyncClone(StorageSystem storageDevice, URI clone, TaskCompleter completer) throws Exception;
	...
	/*
	 * For the given ExportMask, go to the StorageArray and get a mapping of
	 * volumes to their HLUs
	 * 
	 * @param storage the storage system
	 * 
	 * @param exportMask the ExportMask that represents the masking component of
	 * the array
	 * 
	 ...
	 *            The URIs of the BlockSnapshotSession instances in ViPR that
	 *            will represent these array snapshots.
	 * @param groupName
	...
	/**
	 * Creates a new target volume and links it to an array snapshot on the
	 * passed storage system.
	 * 
	 * @param system
	 *            A reference to the storage system.
	 * @param snapSessionURI
	 *            The URI of the BlockSnapshotSession instance in ViPR that
	 *            represents the array snapshot.
	 * @param snapshotURI
	 *            The URI of the BlockSnapshot instance in ViPR that will
	 *            represent the new target volume.
	 * @param copyMode
	...
	/**
	 * Creates a new target volume group and links it to an array snapshot on
	 * the passed storage system.
	 * 
	 * @param system
	 *            A reference to the storage system.
	 * @param snapshotSessionURI
	 * @param snapSessionSnapshotURIs
	...
	/**
	 * Re-links a target volume to an array snapshot on the passed storage
	 * system.
	 * 
	 * @param system
	 *            A reference to the storage system.
	 ...
	 *            The URI of the BlockSnapshotSession instance in ViPR that
	 *            represents the target array snapshot.
	 * @param snapshotURI
	 *            The URI of the BlockSnapshot instance in ViPR that represents
	 ...
	 *            the target volume.
	 * @param deleteTarget
	 *            True if the target should also be deleted.
	 * @param completer
	 *            A reference to the task completer.
	 * 
	 * @throws DeviceControllerException
	 ...
	 *            represents the array snapshot.
	 * @param groupName
	 *            The name of the group when deleting a group snapshot session.
	 * @param completer
	 *            A reference to the task completer.
	 * 
	 * @throws DeviceControllerException
	...
	void doAddSnapshotSessionsToConsistencyGroup(StorageSystem storageSystem, URI consistencyGroup,
			List<URI> addVolumesList, TaskCompleter taskCompleter);
	 ...
	 *            Boolean if true, ViPR will keep group name for CG
	 * @param markInactive
	 * @param sourceReplicationGroup
	 *            name of the source replication group
	 * @param taskCompleter
	 */
	public void doDeleteConsistencyGroup(StorageSystem storage, URI consistencyGroup, String replicationGroupName,
			Boolean keepRGName, Boolean markInactive, String sourceReplicationGroup, TaskCompleter taskCompleter)
			throws DeviceControllerException;
	 ...
	 * 
	 * @param storage
	 *            StorageSystem on which HLU needs to be determined
	 * @param initiatorURIs
	 *            List of Initiator URIs. Cluster export will have more than one
	 *            Initiators from different hosts
	 * @return Map of Initiators to its Volume HLUs
	 * @throws DeviceControllerException
	 *             If error occurs during the processing
	 */
	 ...
	 *            - User friendly name for the Initiator on the Storage System
	 */
