...
public enum ResourceOperationTypeEnum {
    ...
    ASSIGN_FILE_POLICY_TO_FILE_SYSTEM("ASSIGN FILE POLICY TO FILE SYSTEM",
            "assign file policy to existing file system"), CREATE_STORAGE_PORT_GROUP("CREATE STORAGE PORT GROUP",
                    "create storage port group"), DELETE_STORAGE_PORT_GROUP("DELETE STORAGE PORT GROUP", "delete storage port group");
