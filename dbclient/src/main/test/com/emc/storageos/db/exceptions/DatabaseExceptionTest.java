...
public class DatabaseExceptionTest extends BaseServiceCodeExceptionTest {
    ...
    public void generalSerializeException() {
        ...
        assertInternalException(INTERNAL_SERVER_ERROR, DBSVC_SERIALIZATION_ERROR, "Failed to serialize "+DatabaseExceptionTest.class+" object", exception);
    }

    @Test
    public void introspectionException() {
        final DatabaseException exception = DatabaseException.fatals.serializationFailedInitializingBeanInfo(DatabaseExceptionTest.class, new IntrospectionException(EXCEPTION_MESSAGE));
    ...
    public void indexGreaterMax() {
        ...
        assertInternalException(INTERNAL_SERVER_ERROR, DBSVC_SERIALIZATION_ERROR, "Serialization index greater than max expected: " + index, exception);
    }

    @Test
    public void unexpectedIndex() {
        final DatabaseException exception = DatabaseException.fatals.deserializationFailedUnexpectedIndex(DatabaseExceptionTest.class, 1, 7);
    ...
    public void unexpectedType() {
        final DatabaseException exception = DatabaseException.fatals.deserializationFailedUnsupportedType(DatabaseExceptionTest.class, "prop", int.class);
    ...
    public void inconsistentState() {
        final DatabaseException exception = DatabaseException.fatals.serializationFailedInconsistentPropertyMap(DatabaseExceptionTest.class);
        assertInternalException(INTERNAL_SERVER_ERROR, DBSVC_SERIALIZATION_ERROR, "Inconsistent state for PropertyMap while serializing "+DatabaseExceptionTest.class, exception);
    }
