...
public class TestBPMNParserCollaboration {
	...
	public void testSimple() throws ParseException, ParserConfigurationException, SAXException, IOException, ModelException {
		...
		InputStream inputStream = getClass().getResourceAsStream("/collaboration.bpmn");
//		InputStream inputStream = getClass().getResourceAsStream("/createVolumePrelaunchFlow.bpmn20.xml");
