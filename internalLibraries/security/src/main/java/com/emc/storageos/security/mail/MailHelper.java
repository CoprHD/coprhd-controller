...
public class MailHelper {
    ...
    public static final String SMTP_PASSWORD = "system_connectemc_smtp_password"; //NOSONAR ("Suppressing Sonar violation of removing this hard-coded password since it's just the name of attribute")
